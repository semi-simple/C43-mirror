...
dist_macos:	wp43s
	...
	cp res/fonts/*Font.ttf $(MAC_DIST_DIR)/
...
$(BUILD_DIR)/.stamp-rasterFontsData: $(TTF2RASTERFONTS_APP) res/fonts/C43___NumericFont.ttf res/fonts/C43___StandardFont.ttf
