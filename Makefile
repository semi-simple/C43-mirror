...
SRC_WP43S                = \
	...
	$(addprefix src/wp43s/mathematics/, \
		...
		division.c exp.c expMOne.c expt.c factorial.c fib.c floor.c fractionalPart.c gamma.c gcd.c \
	...
	$(addprefix src/wp43s/, \
		addons.c graphs.c jm.c jm_graph.c inlineTest.c keyboardTweak.c radioButtonCatalog.c textfiles.c xeqm.c)
