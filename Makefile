...
SRC_WP43S                = \
	...
	$(addprefix src/wp43s/mathematics/, \
		...
		cxToRe.c cpyx.c idiv.c idivr.c decomp.c dot.c \
		...
		log2.c magnitude.c mant.c max.c min.c minusOnePow.c modulo.c multiplication.c neighb.c parallel.c pcg_basic.c \
		percent.c percentMRR.c percentSigma.c percentT.c power.c prime.c \
