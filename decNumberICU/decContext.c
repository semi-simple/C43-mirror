...
/* ------------------------------------------------------------------ */
const uInt DECPOWERS[10]={1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000};
...
//      context->emin  =   -999;               // //JMMAX -3000 Emin:  WP43S team leader Walter Bonin asked to change this from -6143 to -999
      context->emax  =    6144;              // //JMMAX 3000  Emax:  WP43S team leader Walter Bonin asked to change this from  6144 to  999
      context->emin  =   -6143;              // //JMMAX -3000 Emin:  WP43S team leader Walter Bonin asked to change this from -6143 to -999
      context->round=DEC_ROUND_HALF_EVEN;    // 0.5 to nearest even
      context->traps=0;                      // no traps set
      context->clamp=1;                      // clamp exponents
      #if DECSUBSET
