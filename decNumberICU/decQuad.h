...
/* and therefore also holds useful constants used by all three.       */
  ...
  #define DECQUAD_Emin   -3000      /* minimum adjusted exponent       */ //JMMAX  WP43S team leader Walter Bonin asked to change this from -6143 to -999
  #define DECQUAD_Emax    3000      /* maximum adjusted exponent       */ //JMMAX  WP43S team leader Walter Bonin asked to change this from  6144 to  999
  #define DECQUAD_EmaxD     4      /* maximum exponent digits         */
  #define DECQUAD_Bias    3093      /* bias for the exponent           */ //JMMAX  WP43S team leader Walter Bonin asked to change this from  6176 to 1031
