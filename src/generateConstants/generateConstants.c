...
void generateAllConstants(void) {
  ...
  generateConstant34Array("InchesToM",    "+2.540000000000000000000000000000000000000000000000000000e-02"); // m      = inch * 0,0254
  ...
  generateConstant34Array("YardsToM",     "+9.144000000000000000000000000000000000000000000000000000e-01"); // m      = yard * 3 * 12 * 0.0254
  ...
  generateConstant34Array("AccresToM2",   "+4.046856422400000000000000000000000000000000000000000000e+03"); // m^2    = acre * 0.0254^2 * 12^2 * 43560
  generateConstant34Array("AccresusToM2", "+4.046872609874252006568529266090790246096621225500515517e+03"); // m^2    = acreus * (1200 / 3937)^2 * 43560
