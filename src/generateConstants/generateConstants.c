...
void generateAllConstants(void) {
  ...
  generateConstantArray("AccreToM2",     "+4.046856422400000000000000000000000000000000000000000000e+03"); // cnst107      m²     = acre × 0.0254² × 12² × 43560
  generateConstantArray("AccreusToM2",   "+4.046872609874252006568529266090790246096621225500515517e+03"); // cnst108      m²     = acreus × (1200 / 3937)² × 43560
  ...
  generateConstantArray("CaratToKg",     "+2.000000000000000000000000000000000000000000000000000000e-04"); // cnst116      kg     = carat × 0.0002
  generateConstantArray("OzToKg",        "+2.834952312500000000000000000000000000000000000000000000e-02"); // cnst117      kg     = oz × (0.45359237 / 16)
  generateConstantArray("TrozToKg",      "+3.110347680000000000000000000000000000000000000000000000e-02"); // cnst118      kg     = tr.oz × 0.45359237 × 175 / 12
