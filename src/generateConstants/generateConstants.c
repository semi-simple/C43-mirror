...
void generateAllConstants(void) {
  ...
  c = 0;
  generateConstantArray("0_5",           "+5.000000000000000000000000000000000000000000000000000000e-01"); c++; // math constant 1/2
  ...
  generateConstantArray("0",             "+0.000000000000000000000000000000000000000000000000000000e+00"); c++;
...
int main(void) {
  ...
  fprintf(constantsC, "\n");
  fprintf(constantsC, realPointerDeclarations);
  fprintf(constantsC, "\n");
