...
*/
  ...
  //keyID,   primary,           fShifted,          gShifted,          keyLblAim,         primaryAim,        fShiftedAim,       gShiftedAim,       primaryTam         
      ...
      {41,   ITM_ENTER,         KEY_COMPLEX,       -MNU_CPX,          ITM_ENTER,         ITM_ENTER,         ITM_XEDIT,         CHR_num,           ITM_ENTER          },
      ...
      {45,   ITM_BACKSPACE,     ITM_UNDO,          -MNU_CLR,          ITM_BACKSPACE,     ITM_BACKSPACE,     ITM_NULL,          -MNU_CLR,          ITM_BACKSPACE      },
      ...
      {82,   ITM_0,             ITM_VIEW,          ITM_TIMER,         ITM_0,             ITM_COLON,         ITM_SEMICOLON,     -MNU_ALPHA,        ITM_0              },
  ...
  //keyID,   primary,           fShifted,          gShifted,          keyLblAim,         primaryAim,        fShiftedAim,       gShiftedAim,       primaryTam         
      {21,   ITM_SIGMAPLUS,     ITM_RI,            ITM_TGLFRT,        ITM_NULL,          ITM_A,             -MNU_ALPHAINTL,    ITM_ALPHA,         ITM_REG_A          },
      {22,   ITM_1ONX,          ITM_YX,            ITM_HASH_JM,       ITM_NUMBER_SIGN,   ITM_B,             ITM_NUMBER_SIGN,   ITM_BETA,          ITM_REG_B          },
      {23,   ITM_SQUAREROOTX,   ITM_SQUARE,        ITM_ms,            ITM_CHECK_MARK,    ITM_C,             ITM_CHECK_MARK,    ITM_CHI,           ITM_REG_C          },
      {24,   ITM_LOG10,         ITM_10x,           ITM_dotD,          ITM_NULL,          ITM_D,             ITM_NULL,          ITM_DELTA,         ITM_REG_D          },
      {25,   ITM_LN,            ITM_EXP,           ITM_toREC2,        ITM_NULL,          ITM_E,             ITM_NULL,          ITM_EPSILON,       ITM_NULL           },
      {26,   ITM_XEQ,           ITM_AIM,           ITM_toPOL2,        ITM_NULL,          ITM_F,             ITM_NULL,          ITM_DIGAMMA,       ITM_alpha          },

      {31,   ITM_STO,           ITM_MAGNITUDE,     ITM_ANGLE,         ITM_NULL,          ITM_G,             ITM_NULL,          ITM_GAMMA,         ITM_NULL           },
      {32,   ITM_RCL,           ITM_PC,            ITM_DELTAPC,       ITM_NULL,          ITM_H,             ITM_NULL,          ITM_ETA,           ITM_HEX            },
      {33,   ITM_Rdown,         ITM_CONSTpi,       ITM_XTHROOT,       ITM_NULL,          ITM_I,             ITM_DOWN_ARROW,    ITM_IOTA,          ITM_REG_I          },
      {34,   ITM_sin,           ITM_arcsin,        ITM_GTO,           ITM_NULL,          ITM_J,             CHR_case,          ITM_THETA,         ITM_REG_J          },
      {35,   ITM_cos,           ITM_arccos,        ITM_LBL,           ITM_NULL,          ITM_K,             CHR_num,           ITM_KAPPA,         ITM_REG_K          },
      {36,   ITM_tan,           ITM_arctan,        ITM_RTN,           ITM_NULL,          ITM_L,             ITM_NULL,          ITM_LAMBDA,        ITM_REG_L          },

      {41,   ITM_ENTER,         KEY_COMPLEX,       -MNU_CPX,          ITM_ENTER,         ITM_ENTER,         ITM_NULL,          ITM_NULL,          ITM_ENTER          },
      {42,   ITM_XexY,          ITM_LASTX,         ITM_Rup,           ITM_ex,            ITM_M,             ITM_ex,            ITM_MU,            ITM_NULL           },
      {43,   ITM_CHS,           -MNU_MODE,         -MNU_STK,          ITM_PLUS_MINUS,    ITM_N,             ITM_PLUS_MINUS,    ITM_NU,            ITM_NULL           },
      {44,   ITM_EXPONENT,      -MNU_DSP,          -MNU_EXP,          ITM_NULL,          ITM_O,             ITM_UP_ARROW,      ITM_OMICRON,       ITM_NULL           },
      {45,   ITM_BACKSPACE,     ITM_UNDO,          -MNU_CLR,          ITM_BACKSPACE,     ITM_BACKSPACE,     ITM_UNDO,          -MNU_CLR,          ITM_BACKSPACE      },

      {51,   ITM_UP1,           ITM_BST,           ITM_RBR,           ITM_UP1,           ITM_UP1,           CHR_caseUP,        ITM_UP_ARROW,      ITM_UP1            },
      {52,   ITM_7,             -MNU_EQN,          -MNU_HOME,         ITM_7,             ITM_P,             ITM_7,             ITM_PI,            ITM_7              },
      {53,   ITM_8,             -MNU_ADV,          -MNU_CONST,        ITM_8,             ITM_Q,             ITM_8,             ITM_QOPPA,         ITM_8              },
      {54,   ITM_9,             -MNU_MATX,         -MNU_XFN,          ITM_9,             ITM_R,             ITM_9,             ITM_RHO,           ITM_9              },
      {55,   ITM_DIV,           -MNU_STAT,         -MNU_SUMS,         ITM_OBELUS,        ITM_S,             ITM_OBELUS,        ITM_SIGMA,         ITM_DIV            },

      {61,   ITM_DOWN1,         ITM_SST,           ITM_FLGSV,         ITM_DOWN1,         ITM_DOWN1,         CHR_caseDN,        ITM_DOWN_ARROW,    ITM_DOWN1          },
      {62,   ITM_4,             -MNU_BASE,         -MNU_CLK,          ITM_4,             ITM_T,             ITM_4,             ITM_TAU,           ITM_4              },
      {63,   ITM_5,             -MNU_ANGLECONV,    -MNU_UNITCONV,     ITM_5,             ITM_U,             ITM_5,             ITM_PHI,           ITM_5              },
      {64,   ITM_6,             -MNU_FLAGS,        -MNU_BITS,         ITM_6,             ITM_V,             ITM_6,             ITM_PSI,           ITM_6              },
      {65,   ITM_MULT,          -MNU_PROB,         -MNU_INTS,         ITM_CROSS,         ITM_W,             ITM_CROSS,         ITM_OMEGA,         ITM_MULT           },

      {71,   KEY_fg,            ITM_NULL,          ITM_NULL,          KEY_fg,            KEY_fg,            ITM_NULL,          ITM_NULL,          KEY_fg             },
      {72,   ITM_1,             ITM_ASSIGN,        -MNU_ASN,          ITM_1,             ITM_X,             ITM_1,             ITM_XI,            ITM_1              },
      {73,   ITM_2,             ITM_USERMODE,      -MNU_LOOP,         ITM_2,             ITM_Y,             ITM_2,             ITM_UPSILON,       ITM_2              },
      {74,   ITM_3,             -MNU_PARTS,        -MNU_TEST,         ITM_3,             ITM_Z,             ITM_3,             ITM_ZETA,          ITM_3              },
      {75,   ITM_SUB,           -MNU_FIN,          -MNU_ALPHAFN,      ITM_MINUS,         ITM_UNDERSCORE,    ITM_MINUS,         ITM_SAMPI,         ITM_SUB            },
