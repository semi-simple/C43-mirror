...
// "\x83\x9f" 039F	 Ο 	GREEK CAPITAL LETTER OMICRON           - in font
// "\x83\xbf" 03BF	 ο 	GREEK SMALL LETTER OMICRON             - in font

// "\x83\xd8" 03D8	 Ϙ 	GREEK LETTER ARCHAIC KOPPA
// "\x83\xd9" 03D9	 ϙ 	GREEK SMALL LETTER ARCHAIC KOPPA, value of 90		
// "\x83\xdc" 03DC	 Ϝ 	GREEK LETTER DIGAMMA
// "\x83\xdd" 03DD	 ϝ 	GREEK SMALL LETTER DIGAMMA, value of 6
// "\x83\xe0" 03E0	 Ϡ 	GREEK LETTER SAMPI
// "\x83\xe1" 03E1	 ϡ 	GREEK SMALL LETTER SAMPI, value of 900
// DIGAMMA, OMICRON, QOPPA, SAMPI
		
 #ifdef JM_LAYOUT_1A  //JM LAYOUT 1A. CHALLENGE.
//keyId primary           fShifted         gShifted      keyLblAim       primaryAim         fShiftedAim      gShiftedAim    primaryTam
 {21,   ITM_SIGMAPLUS,    ITM_PROFRC,      ITM_IMPFRC,   ITM_NULL,       CHR_A,             ITM_NULL,        CHR_ALPHA,     ITM_ST_A     }, //JM2 changed top line primary to DM42 keyboard
 {22,   ITM_1X,           ITM_YX,          ITM_toINT,    ITM_NULL,       CHR_B,             ITM_NULL,        CHR_BETA,      ITM_ST_B     }, //JM2 changed top line primary to DM42 keyboard
 {23,   ITM_SQUAREROOTX,  ITM_SQUARE,      ITM_DMS,      ITM_NULL,       CHR_C,             ITM_NULL,        CHR_CHI,       ITM_ST_C     }, //JM2 changed top line primary to DM42 keyboard
 {24,   ITM_LOG10,        ITM_10x,         KEY_dotD,     ITM_NULL,       CHR_D,             ITM_NULL,        CHR_DELTA,     ITM_ST_D     }, // if f or g are changed: adapt the function btnClicked section if(calcMode == CM_NIM) in keyboard.c. Case D for decimal base; //JM2 changed top line primary to DM42 keyboard
 {25,   ITM_LN,           ITM_EX,          ITM_toHMS,    ITM_NULL,       CHR_E,             ITM_NULL,        CHR_EPSILON,   ITM_NULL     }, //JM2 changed top line primary to DM42 keyboard
 {26,   ITM_XEQ,          ITM_GTO,         ITM_LBL,      ITM_NULL,       CHR_F,             ITM_NULL,        CHR_DIGAMMA,   CHR_alpha    }, //JM2 changed top line primary to DM42 keyboard; moved GTO & LBL too
 ...
 {53,   CHR_8,           -MNU_ADV,        -MNU_CNST,     CHR_8,          CHR_Q,             CHR_8,           CHR_QOPPA,     CHR_8        }, //JM2 Move Alpha controls here, from BTN26
 {54,   CHR_9,           -MNU_MATX,       -MNU_XFN,      CHR_9,          CHR_R,             CHR_9,           CHR_RHO,       CHR_9        }, //JM-keyboard re-shuffle
 {55,   ITM_DIV,         -MNU_STAT,       -MNU_SUMS,     CHR_DIVIDE,     CHR_S,             CHR_DIVIDE,      CHR_SIGMA,     ITM_DIV      }, //JM swap XEQ/DIV

 {61,   KEY_DOWN,         KEY_SST,         ITM_STATUS,   KEY_DOWN,       KEY_DOWN,          KEY_SST,         ITM_NULL,      KEY_DOWN     }, //JM swap DN/MIN; Shifted up to match DM42 keyboard
 {62,   CHR_4,            ITM_AIM,        -MNU_CLK,      CHR_4,          CHR_T,             CHR_4,           CHR_TAU,       CHR_4        }, //JM  roll RSTU
 {63,   CHR_5,           -MNU_ANGLECONV,  -MNU_UNITCONV, CHR_5,          CHR_U,             CHR_5,           CHR_PHI,       CHR_5        }, //JM  roll RSTU
 {64,   CHR_6,           -MNU_FLAGS,      -MNU_BITS,     CHR_6,          CHR_V,             CHR_6,           CHR_PSI,       CHR_6        }, //JM  roll RSTU
 {65,   ITM_MULT,        -MNU_PROB,       -MNU_INTS,     CHR_CROSS,      CHR_W,             CHR_CROSS,       CHR_OMEGA,     ITM_MULT     }, //JM  swap UP/MULT & roll
