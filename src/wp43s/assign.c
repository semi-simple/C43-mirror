...
//keyId primary           fShifted         gShifted      keyLblAim        primaryAim         fShiftedAim      gShiftedAim    primaryTam
 {21,   ITM_SIGMAPLUS,    ITM_RI,          ITM_TGLFRT,   ITM_NULL,        ITM_A,            -MNU_ALPHAINTL,   ITM_ALPHA,     ITM_REG_A    }, //JM
 {22,   ITM_1ONX,         ITM_YX,          ITM_HASH_JM,  ITM_NUMBER_SIGN, ITM_B,             ITM_NUMBER_SIGN, ITM_BETA,      ITM_REG_B    }, //JM
 {23,   ITM_SQUAREROOTX,  ITM_SQUARE,      ITM_ms,       ITM_CHECK_MARK,  ITM_C,             ITM_CHECK_MARK,  ITM_CHI,       ITM_REG_C    }, //JM
 {24,   ITM_LOG10,        ITM_10x,         ITM_dotD,     ITM_NULL,        ITM_D,             ITM_NULL,        ITM_DELTA,     ITM_REG_D    }, // if f or g are changed: adapt the function btnClicked section if(calcMode == CM_NIM) in keyboard.c. Case D for decimal base; //JM2 changed top line primary to DM42 keyboard
 ...
 {33,   ITM_Rdown,        ITM_CONSTpi,     ITM_XTHROOT,  ITM_NULL,        ITM_I,             ITM_DOWN_ARROW,  ITM_IOTA,      ITM_REG_I    }, // if f or g are changed: adapt the function btnClicked section if(calcMode == CM_NIM) in keyboard.c. Case H for hexadecimal base
 {34,   ITM_sin,          ITM_arcsin,      ITM_GTO,      ITM_NULL,        ITM_J,             CHR_case,        ITM_THETA,     ITM_REG_J    }, //JM
 {35,   ITM_cos,          ITM_arccos,      ITM_LBL,      ITM_NULL,        ITM_K,             CHR_num,         ITM_KAPPA,     ITM_REG_K    }, //JM
 {36,   ITM_tan,          ITM_arctan,      ITM_RTN,      ITM_NULL,        ITM_L,             ITM_NULL,        ITM_LAMBDA,    ITM_REG_L    }, //JM
...
//keyId primary           fShifted         gShifted      keyLblAim        primaryAim         fShiftedAim      gShiftedAim    primaryTam
 {21,   ITM_SIGMAPLUS,    ITM_SIGMAMINUS,  ITM_TGLFRT,   ITM_NULL,        ITM_A,            -MNU_ALPHAINTL,   ITM_ALPHA,     ITM_REG_A    }, //JM
 {22,   ITM_1ONX,         ITM_YX,          ITM_HASH_JM,  ITM_NUMBER_SIGN, ITM_B,             ITM_NUMBER_SIGN, ITM_BETA,      ITM_REG_B    }, //JM
 {23,   ITM_SQUAREROOTX,  ITM_SQUARE,      ITM_ms,       ITM_CHECK_MARK,  ITM_C,             ITM_CHECK_MARK,  ITM_CHI,       ITM_REG_C    }, //JM
 {24,   ITM_LOG10,        ITM_10x,         ITM_dotD,     ITM_NULL,        ITM_D,             ITM_NULL,        ITM_DELTA,     ITM_REG_D    }, // if f or g are changed: adapt the function btnClicked section if(calcMode == CM_NIM) in keyboard.c. Case D for decimal base; //JM2 changed top line primary to DM42 keyboard
 {25,   ITM_LN,           ITM_EXP,         ITM_toREC2,   ITM_NULL,        ITM_E,             ITM_NULL,        ITM_EPSILON,   ITM_NULL     }, //JM
 ...
 {33,   ITM_Rdown,        ITM_CONSTpi,     ITM_XTHROOT,  ITM_NULL,        ITM_I,             ITM_DOWN_ARROW,  ITM_IOTA,      ITM_REG_I    }, // if f or g are changed: adapt the function btnClicked section if(calcMode == CM_NIM) in keyboard.c. Case H for hexadecimal base
 {34,   ITM_sin,          ITM_arcsin,      ITM_CC,       ITM_NULL,        ITM_J,             CHR_case,        ITM_THETA,     ITM_REG_J    }, //JM
 {35,   ITM_cos,          ITM_arccos,      ITM_LBL,      ITM_NULL,        ITM_K,             CHR_num,         ITM_KAPPA,     ITM_REG_K    }, //JM
 {36,   ITM_tan,          ITM_arctan,      ITM_RTN,      ITM_NULL,        ITM_L,             ITM_NULL,        ITM_LAMBDA,    ITM_REG_L    }, //JM
