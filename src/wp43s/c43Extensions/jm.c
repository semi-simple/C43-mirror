...
void fnUserJM(uint16_t jmUser) {
  ...
  case USER_43S:          //USER
     ...
     kbd_usr[5 ].primary= ITM_SQUAREROOTX; kbd_usr[5].fShifted= ITM_AIM;         kbd_usr[5].gShifted=-MNU_CPX;          kbd_usr[5].keyLblAim=ITM_ROOT_SIGN;   kbd_usr[5].primaryAim=ITM_F;             kbd_usr[5].fShiftedAim= ITM_ROOT_SIGN;      kbd_usr[5].gShiftedAim= ITM_PHI;        kbd_usr[5].primaryTam=ITM_alpha    ;
