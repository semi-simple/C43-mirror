...
void fnUserJM(uint16_t jmUser) {
  ...
  case USER_43S:          //USER
     ...
     kbd_usr[2 ].primary=-MNU_TRI;         kbd_usr[2].fShifted= ITM_DMS;        kbd_usr[2].gShifted=-MNU_ANGLECONV;     kbd_usr[2].keyLblAim=ITM_NULL;         kbd_usr[2].primaryAim=ITM_C;             kbd_usr[2].fShiftedAim= ITM_NULL;         kbd_usr[2].gShiftedAim= ITM_GAMMA;      kbd_usr[2].primaryTam=ITM_REG_C    ;
     kbd_usr[3 ].primary= ITM_LN;          kbd_usr[3].fShifted= ITM_dotD;       kbd_usr[3].gShifted= ITM_LOG10;         kbd_usr[3].keyLblAim=ITM_NULL;         kbd_usr[3].primaryAim=ITM_D;             kbd_usr[3].fShiftedAim= ITM_NULL;         kbd_usr[3].gShiftedAim= ITM_DELTA;      kbd_usr[3].primaryTam=ITM_REG_D    ; // if f or g are changed: adapt the function btnClicked section if(calcMode == CM_NIM) in keyboard.c. Case D for decimal base
     ...
     kbd_usr[5 ].primary= ITM_SQUAREROOTX; kbd_usr[5].fShifted= ITM_AIM;        kbd_usr[5].gShifted=-MNU_CPX;           kbd_usr[5].keyLblAim=ITM_CHECK_MARK;   kbd_usr[5].primaryAim=ITM_F;             kbd_usr[5].fShiftedAim= ITM_CHECK_MARK;   kbd_usr[5].gShiftedAim= ITM_PHI;        kbd_usr[5].primaryTam=ITM_alpha    ;
     ...
     kbd_usr[7 ].primary= ITM_RCL;         kbd_usr[7].fShifted= ITM_RBR;        kbd_usr[7].gShifted= ITM_VIEW;          kbd_usr[7].keyLblAim=ITM_NULL;         kbd_usr[7].primaryAim=ITM_H;             kbd_usr[7].fShiftedAim= ITM_RBR;          kbd_usr[7].gShiftedAim= ITM_CHI;        kbd_usr[7].primaryTam=ITM_HEX      ; // if f or g are changed: adapt the function btnClicked section if(calcMode == CM_NIM) in keyboard.c. Case H for hexadecimal base
     kbd_usr[8 ].primary= ITM_Rdown;       kbd_usr[8].fShifted= ITM_Rup;        kbd_usr[8].gShifted=-MNU_STK;           kbd_usr[8].keyLblAim=ITM_NULL;         kbd_usr[8].primaryAim=ITM_I;             kbd_usr[8].fShiftedAim= ITM_DOWN_ARROW;   kbd_usr[8].gShiftedAim= ITM_IOTA;       kbd_usr[8].primaryTam=ITM_REG_I    ;
     kbd_usr[9 ].primary= ITM_CC;          kbd_usr[9].fShifted= ITM_ANGLE;      kbd_usr[9].gShifted= ITM_MAGNITUDE;     kbd_usr[9].keyLblAim=ITM_NULL;         kbd_usr[9].primaryAim=ITM_J;             kbd_usr[9].fShiftedAim= ITM_NULL;         kbd_usr[9].gShiftedAim= ITM_ETA;        kbd_usr[9].primaryTam=ITM_REG_J    ;
     ...
     kbd_usr[12].primary= ITM_ENTER;      kbd_usr[12].fShifted= ITM_FILL;      kbd_usr[12].gShifted= ITM_DROP;         kbd_usr[12].keyLblAim=ITM_ENTER;       kbd_usr[12].primaryAim=ITM_ENTER;        kbd_usr[12].fShiftedAim= ITM_STATUS;      kbd_usr[12].gShiftedAim= ITM_DROP;      kbd_usr[12].primaryTam=ITM_ENTER    ;
     kbd_usr[13].primary= ITM_XexY;       kbd_usr[13].fShifted= ITM_Xex;       kbd_usr[13].gShifted=-MNU_UNITCONV;     kbd_usr[13].keyLblAim=ITM_ex;          kbd_usr[13].primaryAim=ITM_K;            kbd_usr[13].fShiftedAim= ITM_ex;          kbd_usr[13].gShiftedAim= ITM_KAPPA;     kbd_usr[13].primaryTam=ITM_REG_K    ;
     ...
     kbd_usr[18].primary= ITM_7;          kbd_usr[18].fShifted= ITM_NULL;      kbd_usr[18].gShifted= ITM_NULL;         kbd_usr[18].keyLblAim=ITM_7;           kbd_usr[18].primaryAim=ITM_O;            kbd_usr[18].fShiftedAim= ITM_7;           kbd_usr[18].gShiftedAim= ITM_OMEGA;     kbd_usr[18].primaryTam=ITM_7        ;
     ...
     kbd_usr[27].primary= ITM_SUB;        kbd_usr[27].fShifted= ITM_SHOW;      kbd_usr[27].gShifted=-MNU_INTS;         kbd_usr[27].keyLblAim=ITM_MINUS;       kbd_usr[27].primaryAim=ITM_V;            kbd_usr[27].fShiftedAim= ITM_MINUS;       kbd_usr[27].gShiftedAim=-MNU_ALPHAMATH; kbd_usr[27].primaryTam=ITM_SUB      ;
     ...
     kbd_usr[30].primary= ITM_3;          kbd_usr[30].fShifted=-MNU_CONST;     kbd_usr[30].gShifted= ITM_CONSTpi;      kbd_usr[30].keyLblAim=ITM_3;           kbd_usr[30].primaryAim=ITM_Y;            kbd_usr[30].fShiftedAim= ITM_3;           kbd_usr[30].gShiftedAim= ITM_UPSILON;   kbd_usr[30].primaryTam=ITM_3        ;
