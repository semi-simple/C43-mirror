...
void fnUserJM(uint16_t jmUser) {
  ...
  case USER_43S:          //USER
    ...
    kbd_usr[15].primary=ITM_EXPONENT;                 kbd_usr[15].fShifted=ITM_SHOW;                    kbd_usr[15].gShifted=-MNU_DISP;                    kbd_usr[15].keyLblAim=ITM_NULL;                   kbd_usr[15].primaryAim=ITM_M;                     kbd_usr[15].fShiftedAim=ITM_UP_ARROW;             kbd_usr[15].gShiftedAim=ITM_MU;                   kbd_usr[15].primaryTam=ITM_NULL;                  
