...
void real16ToDisplayString        (const real16_t *real16, bool_t real34, char *displayString, const font_t *font, int16_t maxWidth);
void real16ToDisplayString2       (const real16_t *real16, bool_t real34, char *displayString);
