...
/* 1298 */  { fnCurveFitting,              CF_LINEAR_FITTING_EX,        "ExpF",                                        "ExpF",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1299 */  { fnCurveFitting,              CF_EXPONENTIAL_FITTING_EX,   "LinF",                                        "LinF",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1300 */  { fnCurveFitting,              CF_LOGARITHMIC_FITTING_EX,   "LogF",                                        "LogF",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1301 */  { fnCurveFitting,              CF_POWER_FITTING_EX,         "OrthoF",                                      "OrthoF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1302 */  { fnCurveFitting,              CF_ROOT_FITTING_EX,          "PowerF",                                      "PowerF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1303 */  { fnCurveFitting,              CF_HYPERBOLIC_FITTING_EX,    "GaussF",                                      "GaussF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1304 */  { fnCurveFitting,              CF_PARABOLIC_FITTING_EX,     "CauchF",                                      "CauchF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1305 */  { fnCurveFitting,              CF_CAUCHY_FITTING_EX,        "ParabF",                                      "ParabF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1306 */  { fnCurveFitting,              CF_GAUSS_FITTING_EX,         "HypF",                                        "HypF",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1307 */  { fnCurveFitting,              CF_ORTHOGONAL_FITTING_EX,    "RootF",                                       "RootF",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
...
/* 1762 */  { fnPlotStat,                  PLOT_LR,                     "LRPLOT",                                      "LRPLOT",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 1763 */  { fnPlotStat,                  PLOT_FIT,                    "NXTFIT",                                      "NXTFIT",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
