...
/* 1153 */  { addItemToBuffer,              ITM_PAIR_OF_BARS,            "",                                            "| |",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1154 */  { addItemToBuffer,              ITM_ROOT_PARENTHESES,        "",                                            STD_SQUARE_ROOT "()",                          (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
