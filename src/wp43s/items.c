...
/*  323 */  { fnLog10,                     NOPARAM,                     "LOG" STD_SUB_10,                              "LOG",                                                                        SLS_ENABLED  },      //JM Change lg to LOG
...
/*  487 */  { registerBrowser,             NOPARAM,                     "RBR",                                         "REGS.V",                                                                     SLS_UNCHANGED},      //JM Changed RBR to REGS
...
/*  637 */  { itemToBeCoded,               NOPARAM,                     "TRI",                                         "TRIG",                                                                       SLS_UNCHANGED},      //JM
...
/*  646 */  { itemToBeCoded,               NOPARAM,                     "UNIT",                                        "UNIT",                                                                       SLS_UNCHANGED},      //JM Change U> arrow to CONV. Changed again to UNIT
...
/*  714 */  { itemToBeCoded,               NOPARAM,                     STD_alpha "STR",                               STD_alpha "STR",                                                              SLS_UNCHANGED},      //JM Changed a.FN to STRNG
...
/*  779 */  { fnChangeSign,                ITM_CHS,                     "CHS",                                         "CHS",                                                                        SLS_ENABLED  },      //JM Change +/- to CHS
...
/*  821 */  { itemToBeCoded,               NOPARAM,                     "CONV",                                        "CONV",                                                                       SLS_UNCHANGED},      //JM Change to text DRG and change again to CONV
...
/* 1487 */  { addItemToBuffer,             ITM_EXPONENT,                "",                                            "EEX",                                                                        SLS_UNCHANGED},      //JM Change E to EEX
...
/* 1507 */  { itemToBeCoded,               NOPARAM,                     "",                                            "PRGM",                                                                       SLS_UNCHANGED},      //JM Change P/R to PRGM
...
/* 1893 */  { fnSetSetJM,                  11           ,               "NORM KEY E+ MyMenu",                          STD_SIGMA "+MyMU",                                                            SLS_ENABLED  },      //JM USER
/* 1894 */  { fnShowJM,                    11           ,               "NORM KEY E+ MyMenu?",                         STD_SIGMA "+MyM?",                                                            SLS_ENABLED  },      //JM USER
/* 1895 */  { fnSetSetJM,                  12           ,               "NORM KEY E+ Default",                         STD_SIGMA "+    ",                                                            SLS_ENABLED  },      //JM USER
/* 1896 */  { fnShowJM,                    12           ,               "NORM KEY E+ ?",                               STD_SIGMA "+?   ",                                                            SLS_ENABLED  },      //JM USER
/* 1897 */  { fnSetSetJM,                  13           ,               "NORM KEY E+ PRGM",                            STD_SIGMA "+PRGM",                                                            SLS_ENABLED  },      //JM USER
/* 1898 */  { fnShowJM,                    13           ,               "NORM KEY E+ PRGM?",                           STD_SIGMA "+PGM?",                                                            SLS_ENABLED  },      //JM USER
/* 1899 */  { fnSetSetJM,                  14           ,               "NORM KEY E+ ALPHA",                           STD_SIGMA "+" STD_alpha "   ",                                                SLS_ENABLED  },      //JM USER
/* 1900 */  { fnShowJM,                    14           ,               "NORM KEY E+ ALPHA?",                          STD_SIGMA "+" STD_alpha "?  ",                                                SLS_ENABLED  },      //JM USER
...
/* 1905 */  { itemToBeCoded,               NOPARAM,                     "",                                            "Last item",                                                                  SLS_UNCHANGED}       //JM
};
