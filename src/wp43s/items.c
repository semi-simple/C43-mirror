...
/* 1900 */  { fnGetSigmaAssignToX,         NOPARAM      ,               "SHOW E" STD_SIGMA "TO X",                     STD_SIGMA "+ toX",                                                            CAT_NONE, SLS_UNCHANGED},      //JM USER NORMAL
...
/* 1904 */  { fnJM_GetXToNORMmode,         NOPARAM      ,               "GET X to E" STD_SIGMA,                        "X to"STD_SIGMA "+",                                                          CAT_NONE, SLS_UNCHANGED},      //JM USER NORMAL
