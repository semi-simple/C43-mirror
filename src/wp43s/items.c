...
/* 1398 */  { itemToBeCoded,               NOPARAM,                     "PLOT.LR",                                     "PLOT.LR",                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 1756 */  { fnPlotStat,                  PLOT_ORTHOF,                  "CENTRL"               ,                       "CENTRL"               ,                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1757 */  { itemToBeCoded,               NOPARAM,                     "1757",                                        "1757",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_ENABLED  },
...
/* 1771 */  { itemToBeCoded,               NOPARAM,                     "1771",                                        "1771",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 1821 */  { itemToBeCoded,               NOPARAM,                     "reserved",                                    "reserved",                                    (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GREEK (Reserved - do not use)
/* 1822 */  { itemToBeCoded,               NOPARAM,                     "reserved",                                    "reserved",                                    (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GREEK (Reserved - do not use)
...
/* 1895 */  { itemToBeCoded,               NOPARAM,                     "",                                            "Inl. Tst",                                    (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED},//INLINE_TEST
...
/* 1938 */  { itemToBeCoded,               NOPARAM,                     "ALPHA",                                       "ALPHA",                                       (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED},//JM ALPHA
