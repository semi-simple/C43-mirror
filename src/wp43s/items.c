...
/* 1760 */  { fnPlotStat,                  PLOT_LR,                     "",                                            "LRPLOT",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1761 */  { fnPlotStat,                  PLOT_FIT,                    "",                                            "NXTFIT",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1762 */  { fnStatDemo105,               NOPARAM,                     "",                                            "DEM105",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1763 */  { fnStatDemo107,               NOPARAM,                     "",                                            "DEM107",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1764 */  { fnStatDemo109,               NOPARAM,                     "",                                            "DEM109",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1765 */  { fnPlotZoom,                  NOPARAM,                     "",                                            "ZOOM",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 1848 */  { fnChangeBaseMNU,             NOPARAM,                     "",                                            "MODE#",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 1849 */  { fnDRG,                       NOPARAM,                     "DRG",                                         "DRG",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1850 */  { fnCla,                       NOPARAM,                     "",                                            "CLA",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_DISABLED  | US_UNCHANGED},//GRAPH
/* 1851 */  { fnCln,                       NOPARAM,                     "",                                            "CLN",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_DISABLED  | US_UNCHANGED},//GRAPH
...
/* 1884 */  { fnXEQMXXEQ,                  NOPARAM,                     "",                                            "X.XEQ",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 1937 */  { fnXEQMEDIT,                  NOPARAM,                     "",                                            "X.EDIT",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},
...
/* 2003 */  { fnClAIM,                     NOPARAM,                     "",                                            "EXITCLR",                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_ENABLED  },//clear HEX mode
