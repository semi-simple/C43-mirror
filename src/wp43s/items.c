...
/* 1415 */  { fnClearFlag,                  FLAG_ENDPMT,                 "BeginP",                                      "Begin",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
...
/* 1459 */  { fnSetFlag,                    FLAG_ENDPMT,                 "ENDP",                                        "End",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
