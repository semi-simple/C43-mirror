...
/* 1825 */  { fnSetSetJM,                   JC_GGREEK,                   STD_alpha "gGRK",                              STD_alpha "gGRK",                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED  | EIM_DISABLED},//JM ALPHA GREEK
...
/* 2062 */  { addItemToBuffer,              NOPARAM,                     "",                                            "LOG",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED  | EIM_DISABLED},
/* 2063 */  { addItemToBuffer,              NOPARAM,                     "",                                            "LN",                                          (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED  | EIM_DISABLED},
/* 2064 */  { addItemToBuffer,              NOPARAM,                     "",                                            "xx",                                          (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED  | EIM_DISABLED},
/* 2065 */  { addItemToBuffer,              NOPARAM,                     "",                                            "SIN",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED  | EIM_DISABLED},
/* 2066 */  { addItemToBuffer,              NOPARAM,                     "",                                            "COS",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED  | EIM_DISABLED},
/* 2067 */  { addItemToBuffer,              NOPARAM,                     "",                                            "TAN",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED  | EIM_DISABLED},


/* 2068 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED  | EIM_DISABLED},
