...
/* 1398 */  { fnSolveVar,                   NOPARAM,                     "SOLVE var",                                   "SOLVE var",                                   (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED}, // solver variables
/* 1399 */  { itemToBeCoded,                NOPARAM,                     "SOLVE prog",                                  "SOLVE prog",                                  (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED}, // solver programs
