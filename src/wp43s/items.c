...
/* 1979 */  { fnJMUSERmode,                256+0,                       "",                                            "p00U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1980 */  { fnJMUSERmode_f,              256+0,                       "",                                            "f00U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1981 */  { fnJMUSERmode_g,              256+0,                       "",                                            "g00U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1982 */  { fnJMUSERmode,                256+1,                       "",                                            "p01U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1983 */  { fnJMUSERmode_f,              256+1,                       "",                                            "f01U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1984 */  { fnJMUSERmode_g,              256+1,                       "",                                            "g01U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1985 */  { fnJMUSERmode,                256+2,                       "",                                            "p02U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1986 */  { fnJMUSERmode_f,              256+2,                       "",                                            "f02U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1987 */  { fnJMUSERmode_g,              256+2,                       "",                                            "g02U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1988 */  { fnJMUSERmode,                256+3,                       "",                                            "p03U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1989 */  { fnJMUSERmode_f,              256+3,                       "",                                            "f03U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1990 */  { fnJMUSERmode_g,              256+3,                       "",                                            "g03U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1991 */  { fnJMUSERmode,                256+4,                       "",                                            "p04U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1992 */  { fnJMUSERmode_f,              256+4,                       "",                                            "f04U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1993 */  { fnJMUSERmode_g,              256+4,                       "",                                            "g04U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1994 */  { fnJMUSERmode,                256+5,                       "",                                            "p05U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1995 */  { fnJMUSERmode_f,              256+5,                       "",                                            "f05U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1996 */  { fnJMUSERmode_g,              256+5,                       "",                                            "g05U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1997 */  { fnJMUSERmode,                256+6,                       "",                                            "p06U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1998 */  { fnJMUSERmode_f,              256+6,                       "",                                            "f06U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1999 */  { fnJMUSERmode_g,              256+6,                       "",                                            "g06U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2000 */  { fnJMUSERmode,                256+7,                       "",                                            "p07U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2001 */  { fnJMUSERmode_f,              256+7,                       "",                                            "f07U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2002 */  { fnJMUSERmode_g,              256+7,                       "",                                            "g07U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2003 */  { fnJMUSERmode,                256+8,                       "",                                            "p08U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2004 */  { fnJMUSERmode_f,              256+8,                       "",                                            "f08U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2005 */  { fnJMUSERmode_g,              256+8,                       "",                                            "g08U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2006 */  { fnJMUSERmode,                256+9,                       "",                                            "p09U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2007 */  { fnJMUSERmode_f,              256+9,                       "",                                            "f09U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2008 */  { fnJMUSERmode_g,              256+9,                       "",                                            "g09U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2009 */  { fnJMUSERmode,                256+10,                      "",                                            "p10U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2010 */  { fnJMUSERmode_f,              256+10,                      "",                                            "f10U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2011 */  { fnJMUSERmode_g,              256+10,                      "",                                            "g10U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2012 */  { fnJMUSERmode,                256+11,                      "",                                            "p11U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2013 */  { fnJMUSERmode_f,              256+11,                      "",                                            "f11U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2014 */  { fnJMUSERmode_g,              256+11,                      "",                                            "g11U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2015 */  { fnJMUSERmode,                256+12,                      "",                                            "p12U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2016 */  { fnJMUSERmode_f,              256+12,                      "",                                            "f12U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2017 */  { fnJMUSERmode_g,              256+12,                      "",                                            "g12U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2018 */  { fnJMUSERmode,                256+13,                      "",                                            "p13U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2019 */  { fnJMUSERmode_f,              256+13,                      "",                                            "f13U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2020 */  { fnJMUSERmode_g,              256+13,                      "",                                            "g13U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2021 */  { fnJMUSERmode,                256+14,                      "",                                            "p14U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2022 */  { fnJMUSERmode_f,              256+14,                      "",                                            "f14U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2023 */  { fnJMUSERmode_g,              256+14,                      "",                                            "g14U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2024 */  { fnJMUSERmode,                256+15,                      "",                                            "p15U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2025 */  { fnJMUSERmode_f,              256+15,                      "",                                            "f15U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2026 */  { fnJMUSERmode_g,              256+15,                      "",                                            "g15U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2027 */  { fnJMUSERmode,                256+16,                      "",                                            "p16U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2028 */  { fnJMUSERmode_f,              256+16,                      "",                                            "f16U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2029 */  { fnJMUSERmode_g,              256+16,                      "",                                            "g16U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2030 */  { fnXEQMENU,                   1,                           "XEQM01",                                      "XEQM01",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2031 */  { fnXEQMENU,                   2,                           "XEQM02",                                      "XEQM02",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2032 */  { fnXEQMENU,                   3,                           "XEQM03",                                      "XEQM03",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2033 */  { fnXEQMENU,                   4,                           "XEQM04",                                      "XEQM04",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2034 */  { fnXEQMENU,                   5,                           "XEQM05",                                      "XEQM05",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2035 */  { fnXEQMENU,                   6,                           "XEQM06",                                      "XEQM06",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2036 */  { fnXEQMENU,                   7,                           "XEQM07",                                      "XEQM07",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2037 */  { fnXEQMENU,                   8,                           "XEQM08",                                      "XEQM08",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2038 */  { fnXEQMENU,                   9,                           "XEQM09",                                      "XEQM09",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2039 */  { fnXEQMENU,                   10,                          "XEQM10",                                      "XEQM10",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2040 */  { fnXEQMENU,                   11,                          "XEQM11",                                      "XEQM11",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2041 */  { fnXEQMENU,                   12,                          "XEQM12",                                      "XEQM12",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2042 */  { fnXEQMENU,                   13,                          "XEQM13",                                      "XEQM13",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2043 */  { fnXEQMENU,                   14,                          "XEQM14",                                      "XEQM14",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2044 */  { fnXEQMENU,                   15,                          "XEQM15",                                      "XEQM15",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2045 */  { fnXEQMENU,                   16,                          "XEQM16",                                      "XEQM16",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2046 */  { fnXEQMENU,                   17,                          "XEQM17",                                      "XEQM17",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2047 */  { fnXEQMENU,                   18,                          "XEQM18",                                      "XEQM18",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EXEC
/* 2048 */  { fnXEQMSAVE,                  TM_VALUE,                    "X.SAVE",                                      "X.SAVE",                                      (1 << TAM_MAX_BITS) |    18, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},
/* 2049 */  { fnXEQMLOAD,                  TM_VALUE,                    "X.LOAD",                                      "X.LOAD",                                      (1 << TAM_MAX_BITS) |    18, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 2050 */  { fnFb,                        0,                           "FB00",                                        "FB00",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2051 */  { fnFb,                        1,                           "FB01",                                        "FB01",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2052 */  { fnFb,                        2,                           "FB02",                                        "FB02",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2053 */  { fnFb,                        3,                           "FB03",                                        "FB03",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2054 */  { fnFb,                        4,                           "FB04",                                        "FB04",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2055 */  { fnFb,                        5,                           "FB05",                                        "FB05",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2056 */  { fnFb,                        6,                           "FB06",                                        "FB06",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2057 */  { fnFb,                        7,                           "FB07",                                        "FB07",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2058 */  { fnFb,                        8,                           "FB08",                                        "FB08",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2059 */  { fnFb,                        9,                           "FB09",                                        "FB09",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2060 */  { fnFb,                        10,                          "FB10",                                        "FB10",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2061 */  { fnFb,                        11,                          "FB11",                                        "FB11",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2062 */  { fnFb,                        12,                          "FB12",                                        "FB12",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2063 */  { fnFb,                        13,                          "FB13",                                        "FB13",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2064 */  { fnFb,                        14,                          "FB14",                                        "FB14",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2065 */  { fnFb,                        15,                          "FB15",                                        "FB15",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2066 */  { fnFb,                        16,                          "FB16",                                        "FB16",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2067 */  { fnFb,                        17,                          "FB17",                                        "FB17",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2068 */  { fnFb,                        18,                          "FB18",                                        "FB18",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2069 */  { fnFb,                        19,                          "FB19",                                        "FB19",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2070 */  { fnFb,                        20,                          "FB20",                                        "FB20",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2071 */  { fnFb,                        21,                          "FB21",                                        "FB21",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2072 */  { fnFb,                        22,                          "FB22",                                        "FB22",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2073 */  { fnFb,                        23,                          "FB23",                                        "FB23",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2074 */  { fnFb,                        24,                          "FB24",                                        "FB24",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2075 */  { fnFb,                        25,                          "FB25",                                        "FB25",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2076 */  { fnFb,                        26,                          "FB26",                                        "FB26",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2077 */  { fnFb,                        27,                          "FB27",                                        "FB27",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2078 */  { fnFb,                        28,                          "FB28",                                        "FB28",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2079 */  { fnFb,                        29,                          "FB29",                                        "FB29",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2080 */  { fnFb,                        30,                          "FB30",                                        "FB30",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2081 */  { fnFb,                        31,                          "FB31",                                        "FB31",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2082 */  { fnFb,                        32,                          "FB32",                                        "FB32",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2083 */  { fnFb,                        33,                          "FB33",                                        "FB33",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2084 */  { fnFb,                        34,                          "FB34",                                        "FB34",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2085 */  { fnFb,                        35,                          "FB35",                                        "FB35",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2086 */  { fnFb,                        36,                          "FB36",                                        "FB36",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2087 */  { fnFb,                        37,                          "FB37",                                        "FB37",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2088 */  { fnFb,                        38,                          "FB38",                                        "FB38",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2089 */  { fnFb,                        39,                          "FB39",                                        "FB39",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2090 */  { fnFb,                        40,                          "FB40",                                        "FB40",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2091 */  { fnFb,                        41,                          "FB41",                                        "FB41",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2092 */  { fnFb,                        42,                          "FB42",                                        "FB42",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2093 */  { fnFb,                        43,                          "FB43",                                        "FB43",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2094 */  { fnFb,                        44,                          "FB44",                                        "FB44",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2095 */  { fnFb,                        45,                          "FB45",                                        "FB45",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2096 */  { fnFb,                        46,                          "FB46",                                        "FB46",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2097 */  { fnFb,                        47,                          "FB47",                                        "FB47",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2098 */  { fnFb,                        48,                          "FB48",                                        "FB48",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2099 */  { fnFb,                        49,                          "FB49",                                        "FB49",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2100 */  { fnFb,                        50,                          "FB50",                                        "FB50",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2101 */  { fnFb,                        51,                          "FB51",                                        "FB51",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2102 */  { fnFb,                        52,                          "FB52",                                        "FB52",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2103 */  { fnFb,                        53,                          "FB53",                                        "FB53",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2104 */  { fnFb,                        54,                          "FB54",                                        "FB54",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2105 */  { fnFb,                        55,                          "FB55",                                        "FB55",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2106 */  { fnFb,                        56,                          "FB56",                                        "FB56",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2107 */  { fnFb,                        57,                          "FB57",                                        "FB57",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2108 */  { fnFb,                        58,                          "FB58",                                        "FB58",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2109 */  { fnFb,                        59,                          "FB59",                                        "FB59",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2110 */  { fnFb,                        60,                          "FB60",                                        "FB60",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2111 */  { fnFb,                        61,                          "FB61",                                        "FB61",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2112 */  { fnFb,                        62,                          "FB62",                                        "FB62",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2113 */  { fnFb,                        63,                          "FB63",                                        "FB63",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2114 */  { fnByteShortcutsS,            6,                           "S06",                                         "S06",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2115 */  { fnByteShortcutsS,            8,                           "S08",                                         "S08",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2116 */  { fnByteShortcutsS,            16,                          "S16",                                         "S16",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2117 */  { fnByteShortcutsS,            32,                          "S32",                                         "S32",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2118 */  { fnByteShortcutsS,            64,                          "S64",                                         "S64",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2119 */  { fnByteShortcutsU,            6,                           "U06",                                         "U06",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2120 */  { fnByteShortcutsU,            8,                           "U08",                                         "U08",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2121 */  { fnByteShortcutsU,            16,                          "U16",                                         "U16",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2122 */  { fnByteShortcutsU,            32,                          "U32",                                         "U32",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2123 */  { fnByteShortcutsU,            64,                          "U64",                                         "U64",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2124 */  { fnByte,                      1,                           "SL1",                                         "SL1",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2125 */  { fnByte,                      2,                           "SR1",                                         "SR1",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2126 */  { fnByte,                      3,                           "RL1",                                         "RL1",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2127 */  { fnByte,                      4,                           "RR1",                                         "RR1",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOI
/* 2128 */  { fnByte,                      5,                           "SWAP.W",                                      "SWAP.W",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED  },//JM SHOI
/* 2129 */  { fnByte,                      6,                           "SWAP.B",                                      "SWAP.B",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED  },//JM SHOI
/* 2130 */  { fnClAIM,                     NOPARAM,                     "EXITCLR",                                     "EXITCLR",                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_ENABLED  },//clear HEX mode
/* 2131 */  { fnShoiXRepeats,              TM_VALUE,                    "DISP_SI",                                     "DISP_SI",                                     (0 << TAM_MAX_BITS) |     3, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM SHOI
/* 2132 */  { fnScale,                     NOPARAM,                     "TICKS",                                       "TICKS",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GRAPHING
/* 2133 */  { fnPlotLS,                    NOPARAM,                     "PLOTLS",                                      "PLOTLS",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2134 */  { fnPline,                     NOPARAM,                     "LINE",                                        "LINE",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2135 */  { fnPcros,                     NOPARAM,                     "CROSS",                                       "CROSS",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2136 */  { fnPbox,                      NOPARAM,                     "BOX",                                         "BOX",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2137 */  { fnPvect,                     NOPARAM,                     "VECT",                                        "VECT",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM VECTOR MODE
/* 2138 */  { fnPNvect,                    NOPARAM,                     "N.VECT",                                      "N.VECT",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM VECTOR MODE
/* 2139 */  { fnPx,                        NOPARAM,                     "MAGN.X",                                      "MAGN.X",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2140 */  { fnPy,                        NOPARAM,                     "MAGN.Y",                                      "MAGN.Y",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2141 */  { fnGraph,                     9,                           "SOLV2",                                       "SOLV2",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2142 */  { fnGraph,                     10,                          "SOLV3",                                       "SOLV3",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2143 */  { fnGraph,                     11,                          "DEMO1",                                       "DEMO1",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2144 */  { fnGraph,                     12,                          "DEMO2",                                       "DEMO2",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2145 */  { fnGraph,                     13,                          "DEMO3",                                       "DEMO3",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2146 */  { fnGraph,                     14,                          "DEMO4",                                       "DEMO4",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2147 */  { fnGraph,                     15,                          "DEMO5",                                       "DEMO5",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2148 */  { fnGraph,                     16,                          "DEMO6",                                       "DEMO6",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2149 */  { fnPintg,                     NOPARAM,                     STD_SIGMA STD_y_BAR STD_DELTA "x",             STD_SIGMA STD_y_BAR STD_DELTA "x",             (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2150 */  { fnPdiff,                     NOPARAM,                     STD_DELTA "y/" STD_DELTA "x",                  STD_DELTA "y/" STD_DELTA "x",                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2151 */  { fnPrms,                      NOPARAM,                     "RMS",                                         "RMS",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2152 */  { fnPshade,                    NOPARAM,                     STD_INTEGRAL "AREA",                           STD_INTEGRAL "AREA",                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2153 */  { itemToBeCoded,               NOPARAM,                     "PLOTMNU",                                     "PLOTMNU",                                     (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED},
/* 2154 */  { fnSetSetJM,                  JC_NL,                       "",                                            STD_num,                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2155 */  { itemToBeCoded,               NOPARAM,                     "NLock",                                       "NLock",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2156 */  { itemToBeCoded,               NOPARAM,                     "Nulock",                                      "Nulock",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2157 */  { addItemToBuffer,             ITM_EEXCHR,                  STD_SUB_E_OUTLINE,                             STD_SUB_E_OUTLINE,                             (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2158 */  { fnClGrf,                     NOPARAM,                     "CLGRF",                                       "CLGRF",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_ENABLED  },
/* 2159 */  { fnPzoom,                     1,                           "ZOOMx",                                       "ZOOMx",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2160 */  { fnPzoom,                     2,                           "ZOOMy",                                       "ZOOMy",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//GRAPH
/* 2161 */  { fnGraph,                     20,                          "X.SOLV",                                      "X.SOLV",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2162 */  { fnGraph,                     21,                          "X.PLOT",                                      "X.PLOT",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2163 */  { fnGraph,                     22,                          "X.DEMO",                                      "X.DEMO",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2164 */  { fnP_All_Regs,                1,                           "PRN",                                         "PRN",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 2165 */  { fnPlot,                      NOPARAM,                     "PLOT_J",                                      "PLOT_J",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2166 */  { fnUserJM,                    USER_DRG,                    "U" STD_SIGMA STD_DOT "DRG",                   "U" STD_SIGMA STD_DOT "DRG",                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2167 */  { itemToBeCoded,               NOPARAM,                     "2167",                                        "2167",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_ENABLED  },

/* 2168 */  { itemToBeCoded,               NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},
};
