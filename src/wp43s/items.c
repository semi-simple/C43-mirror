...
/* 1883 */  { fnSigmaAssign,               KEY_USERMODE,                STD_SIGMA "+USR",                              STD_SIGMA "+USR",                              0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},
/* 1884 */  { fnSigmaAssign,               KEY_CC,                      STD_SIGMA "+CC",                               STD_SIGMA "+CC",                               0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},
...
/* 1954 */  { fnJMUSERmode,                256+0,                       "",                                            "K_00U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1955 */  { fnJMUSERmode_f,              256+0,                       "",                                            "Kf00U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1956 */  { fnJMUSERmode_g,              256+0,                       "",                                            "Kg00U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1957 */  { fnJMUSERmode,                256+1,                       "",                                            "K_01U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1958 */  { fnJMUSERmode_f,              256+1,                       "",                                            "Kf01U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1959 */  { fnJMUSERmode_g,              256+1,                       "",                                            "Kg01U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1960 */  { fnJMUSERmode,                256+2,                       "",                                            "K_02U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1961 */  { fnJMUSERmode_f,              256+2,                       "",                                            "Kf02U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1962 */  { fnJMUSERmode_g,              256+2,                       "",                                            "Kg02U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1963 */  { fnJMUSERmode,                256+3,                       "",                                            "K_03U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1964 */  { fnJMUSERmode_f,              256+3,                       "",                                            "Kf03U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1965 */  { fnJMUSERmode_g,              256+3,                       "",                                            "Kg03U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1966 */  { fnJMUSERmode,                256+4,                       "",                                            "K_04U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1967 */  { fnJMUSERmode_f,              256+4,                       "",                                            "Kf04U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1968 */  { fnJMUSERmode_g,              256+4,                       "",                                            "Kg04U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1969 */  { fnJMUSERmode,                256+5,                       "",                                            "K_05U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1970 */  { fnJMUSERmode_f,              256+5,                       "",                                            "Kf05U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1971 */  { fnJMUSERmode_g,              256+5,                       "",                                            "Kg05U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1972 */  { fnJMUSERmode,                256+6,                       "",                                            "K_06U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1973 */  { fnJMUSERmode_f,              256+6,                       "",                                            "Kf06U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1974 */  { fnJMUSERmode_g,              256+6,                       "",                                            "Kg06U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1975 */  { fnJMUSERmode,                256+7,                       "",                                            "K_07U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1976 */  { fnJMUSERmode_f,              256+7,                       "",                                            "Kf07U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1977 */  { fnJMUSERmode_g,              256+7,                       "",                                            "Kg07U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1978 */  { fnJMUSERmode,                256+8,                       "",                                            "K_08U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1979 */  { fnJMUSERmode_f,              256+8,                       "",                                            "Kf08U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1980 */  { fnJMUSERmode_g,              256+8,                       "",                                            "Kg08U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1981 */  { fnJMUSERmode,                256+9,                       "",                                            "K_09U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1982 */  { fnJMUSERmode_f,              256+9,                       "",                                            "Kf09U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1983 */  { fnJMUSERmode_g,              256+9,                       "",                                            "Kg09U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1984 */  { fnJMUSERmode,                256+10,                      "",                                            "K_10U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1985 */  { fnJMUSERmode_f,              256+10,                      "",                                            "Kf10U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1986 */  { fnJMUSERmode_g,              256+10,                      "",                                            "Kg10U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1987 */  { fnJMUSERmode,                256+11,                      "",                                            "K_11U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1988 */  { fnJMUSERmode_f,              256+11,                      "",                                            "Kf11U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1989 */  { fnJMUSERmode_g,              256+11,                      "",                                            "Kg11U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1990 */  { fnJMUSERmode,                256+12,                      "",                                            "K_12U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1991 */  { fnJMUSERmode_f,              256+12,                      "",                                            "Kf12U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1992 */  { fnJMUSERmode_g,              256+12,                      "",                                            "Kg12U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1993 */  { fnJMUSERmode,                256+13,                      "",                                            "K_13U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1994 */  { fnJMUSERmode_f,              256+13,                      "",                                            "Kf13U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1995 */  { fnJMUSERmode_g,              256+13,                      "",                                            "Kg13U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1996 */  { fnJMUSERmode,                256+14,                      "",                                            "K_14U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1997 */  { fnJMUSERmode_f,              256+14,                      "",                                            "Kf14U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1998 */  { fnJMUSERmode_g,              256+14,                      "",                                            "Kg14U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1999 */  { fnJMUSERmode,                256+15,                      "",                                            "K_15U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2000 */  { fnJMUSERmode_f,              256+15,                      "",                                            "Kf15U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2001 */  { fnJMUSERmode_g,              256+15,                      "",                                            "Kg15U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2002 */  { fnJMUSERmode,                256+16,                      "",                                            "K_16U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2003 */  { fnJMUSERmode_f,              256+16,                      "",                                            "Kf16U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2004 */  { fnJMUSERmode_g,              256+16,                      "",                                            "Kg16U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2005 */  { fnJMUSERmode,                256+17,                      "",                                            "K_17U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2006 */  { fnJMUSERmode_f,              256+17,                      "",                                            "Kf17U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2007 */  { fnJMUSERmode_g,              256+17,                      "",                                            "Kg17U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2008 */  { fnJMUSERmode,                256+18,                      "",                                            "K_18U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2009 */  { fnJMUSERmode_f,              256+18,                      "",                                            "Kf18U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2010 */  { fnJMUSERmode_g,              256+18,                      "",                                            "Kg18U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2011 */  { fnJMUSERmode,                256+19,                      "",                                            "K_19U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2012 */  { fnJMUSERmode_f,              256+19,                      "",                                            "Kf19U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2013 */  { fnJMUSERmode_g,              256+19,                      "",                                            "Kg19U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2014 */  { fnJMUSERmode,                256+20,                      "",                                            "K_20U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2015 */  { fnJMUSERmode_f,              256+20,                      "",                                            "Kf20U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2016 */  { fnJMUSERmode_g,              256+20,                      "",                                            "Kg20U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2017 */  { fnJMUSERmode,                256+21,                      "",                                            "K_21U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2018 */  { fnJMUSERmode_f,              256+21,                      "",                                            "Kf21U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2019 */  { fnJMUSERmode_g,              256+21,                      "",                                            "Kg21U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2020 */  { fnJMUSERmode,                256+22,                      "",                                            "K_22U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2021 */  { fnJMUSERmode_f,              256+22,                      "",                                            "Kf22U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2022 */  { fnJMUSERmode_g,              256+22,                      "",                                            "Kg22U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2023 */  { fnJMUSERmode,                256+23,                      "",                                            "K_23U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2024 */  { fnJMUSERmode_f,              256+23,                      "",                                            "Kf23U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2025 */  { fnJMUSERmode_g,              256+23,                      "",                                            "Kg23U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2026 */  { fnJMUSERmode,                256+24,                      "",                                            "K_24U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2027 */  { fnJMUSERmode_f,              256+24,                      "",                                            "Kf24U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2028 */  { fnJMUSERmode_g,              256+24,                      "",                                            "Kg24U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2029 */  { fnJMUSERmode,                256+25,                      "",                                            "K_25U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2030 */  { fnJMUSERmode_f,              256+25,                      "",                                            "Kf25U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2031 */  { fnJMUSERmode_g,              256+25,                      "",                                            "Kg25U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2032 */  { fnJMUSERmode,                256+26,                      "",                                            "K_26U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2033 */  { fnJMUSERmode_f,              256+26,                      "",                                            "Kf26U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2034 */  { fnJMUSERmode_g,              256+26,                      "",                                            "Kg26U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2035 */  { fnJMUSERmode,                256+27,                      "",                                            "K_27U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2036 */  { fnJMUSERmode_f,              256+27,                      "",                                            "Kf27U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2037 */  { fnJMUSERmode_g,              256+27,                      "",                                            "Kg27U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2038 */  { fnJMUSERmode,                256+28,                      "",                                            "K_28U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2039 */  { fnJMUSERmode_f,              256+28,                      "",                                            "Kf28U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2040 */  { fnJMUSERmode_g,              256+28,                      "",                                            "Kg28U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2041 */  { fnJMUSERmode,                256+29,                      "",                                            "K_29U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2042 */  { fnJMUSERmode_f,              256+29,                      "",                                            "Kf29U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2043 */  { fnJMUSERmode_g,              256+29,                      "",                                            "Kg29U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2044 */  { fnJMUSERmode,                256+30,                      "",                                            "K_30U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2045 */  { fnJMUSERmode_f,              256+30,                      "",                                            "Kf30U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2046 */  { fnJMUSERmode_g,              256+30,                      "",                                            "Kg30U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2047 */  { fnJMUSERmode,                256+31,                      "",                                            "K_31U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2048 */  { fnJMUSERmode_f,              256+31,                      "",                                            "Kf31U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2049 */  { fnJMUSERmode_g,              256+31,                      "",                                            "Kg31U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2050 */  { fnJMUSERmode,                256+32,                      "",                                            "K_32U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2051 */  { fnJMUSERmode_f,              256+32,                      "",                                            "Kf32U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2052 */  { fnJMUSERmode_g,              256+32,                      "",                                            "Kg32U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2053 */  { fnJMUSERmode,                256+33,                      "",                                            "K_33U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2054 */  { fnJMUSERmode_f,              256+33,                      "",                                            "Kf33U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2055 */  { fnJMUSERmode_g,              256+33,                      "",                                            "Kg33U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2056 */  { fnJMUSERmode,                256+34,                      "",                                            "K_34U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2057 */  { fnJMUSERmode_f,              256+34,                      "",                                            "Kf34U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2058 */  { fnJMUSERmode_g,              256+34,                      "",                                            "Kg34U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2059 */  { fnJMUSERmode,                256+35,                      "",                                            "K_35U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2060 */  { fnJMUSERmode_f,              256+35,                      "",                                            "Kf35U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2061 */  { fnJMUSERmode_g,              256+35,                      "",                                            "Kg35U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2062 */  { fnJMUSERmode,                256+36,                      "",                                            "K_36U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 2063 */  { fnJMUSERmode_f,              256+36,                      "",                                            "Kf36U",                                       0,       0,       CAT_NONE, SLS_UNCHANGED, US_UNCHANGED},//JM User mode (Will remove later - reserved)
