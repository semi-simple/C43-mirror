...
/* 1883 */  { fnUserJM,                     USER_ALPHA,                  "",                                            STD_DOT STD_alpha,                             (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1884 */  { fnUserJM,                     USER_GSHFT,                  "",                                            STD_DOT "G" STD_DOT "SH",                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1885 */  { fnUserJM,                     USER_CC,                     "",                                            STD_DOT "CC",                                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1886 */  { fnUserJM,                     USER_MYM,                    "",                                            STD_DOT "MYM",                                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1887 */  { fnUserJM,                     USER_PRGM,                   "",                                            STD_DOT "PRGM",                                (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1888 */  { fnUserJM,                     USER_USER,                   "",                                            STD_DOT "USER",                                (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1889 */  { fnUserJM,                     USER_SIGMAPLUS,              "",                                            STD_DOT STD_SIGMA "+",                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 1892 */  { fnUserJM,                     USER_HOME,                   "",                                            STD_DOT "HOME",                                (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 2037 */  { fnUserJM,                     USER_DRG,                    "",                                            STD_DOT "DRG",                                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 2046 */  { fnUserJM,                     USER_SNAP,                   "",                                            STD_DOT "SNAP",                                (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},

/* 2047 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},
};
