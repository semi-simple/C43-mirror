...
/* 1852 */  { fnLongInt,                   NOPARAM,                     "LNGINT",                                      "LNGINT",                                      0,       0,       CAT_FNCT, SLS_ENABLED  , US_ENABLED  },
...
/* 1964 */  { fnAngularModeJM,             AM_HMS,                      STD_RIGHT_DOUBLE_ANGLE "H.MS",                 STD_RIGHT_DOUBLE_ANGLE "h.ms",                 0,       0,       CAT_FNCT, SLS_UNCHANGED, US_ENABLED  },
