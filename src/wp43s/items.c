...
/*  117 */  { fnAngularMode,               AM_DEGREE,                   "DEG" STD_SUB_o,                               "DEG",                                         0,       0,       CAT_FNCT, SLS_UNCHANGED},
...
/*  134 */  { fnAngularMode,               AM_DMS,                      "D.MS" STD_SUB_o,                              "d.ms",                                        0,       0,       CAT_FNCT, SLS_UNCHANGED},
...
/*  229 */  { fnAngularMode,               AM_GRAD,                     "GRAD" STD_SUB_o,                              "GRAD",                                        0,       0,       CAT_FNCT, SLS_UNCHANGED},
...
/*  323 */  { fnLog10,                     NOPARAM     /*# JM #*/,      "LOG" STD_SUB_1 STD_SUB_0,                     "LOG",                                         0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM Change lg to LOG
...
/*  375 */  { fnAngularMode,               AM_MULTPI,                   "MUL" STD_pi STD_SUB_o,                        "MUL" STD_pi,                                  0,       0,       CAT_FNCT, SLS_UNCHANGED},
...
/*  483 */  { fnAngularMode,               AM_RADIAN,                   "RAD" STD_SUB_o,                               "RAD",                                         0,       0,       CAT_FNCT, SLS_UNCHANGED},
...
/*  795 */  { fnToPolar,                   NOPARAM     /*# JM #*/,      STD_RIGHT_ARROW "POL" STD_SUB_o,               STD_RIGHT_ARROW "P" STD_SUB_o,                 0,       0,       CAT_NONE, SLS_ENABLED  },   //JM TEXT & point to function to add POLAR/RECT
...
/*  798 */  { fnToRect,                    NOPARAM     /*# JM #*/,      STD_RIGHT_ARROW "REC" STD_SUB_o,               "R" STD_LEFT_ARROW STD_SUB_o,                  0,       0,       CAT_NONE, SLS_ENABLED  },   //SWAPPED ARROW DIRECTION & JM TEXT & point to function to add POLAR/RECT
...
/* 1685 */  { fnChangeBaseJM,              2,                           "BIN",                                         "BIN",                                         0,       0,       CAT_FNCT, SLS_UNCHANGED},   //JM HEX
/* 1686 */  { fnChangeBaseJM,              8,                           "OCT",                                         "OCT",                                         0,       0,       CAT_FNCT, SLS_UNCHANGED},   //JM HEX
/* 1687 */  { fnChangeBaseJM,              10,                          "DEC",                                         "DEC",                                         0,       0,       CAT_FNCT, SLS_UNCHANGED},   //JM HEX
/* 1688 */  { fnChangeBaseJM,              16,                          "HEX",                                         "HEX",                                         0,       0,       CAT_FNCT, SLS_UNCHANGED},   //JM HEX
...
/* 1737 */  { itemToBeCoded/*fnBASE_Hash*/,NOPARAM,                     "##" STD_RIGHT_ARROW "INT",                    "##" STD_RIGHT_ARROW "INT",                    0,       0,       CAT_NONE, SLS_UNCHANGED},   //JM ##
...
/* 1887 */  { fnUserJM,                    USER_SHIFTS,                 "C43 ALT",                                     "C43 ALT",                                     0,       0,       CAT_NONE, SLS_UNCHANGED},   //JM USER
...
/* 1979 */  { fnXEQMENU,                   1,                           "XEQM01",                                      "XEQM01",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1980 */  { fnXEQMENU,                   2,                           "XEQM02",                                      "XEQM02",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1981 */  { fnXEQMENU,                   3,                           "XEQM03",                                      "XEQM03",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1982 */  { fnXEQMENU,                   4,                           "XEQM04",                                      "XEQM04",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1983 */  { fnXEQMENU,                   5,                           "XEQM05",                                      "XEQM05",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1984 */  { fnXEQMENU,                   6,                           "XEQM06",                                      "XEQM06",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1985 */  { fnXEQMENU,                   7,                           "XEQM07",                                      "XEQM07",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1986 */  { fnXEQMENU,                   8,                           "XEQM08",                                      "XEQM08",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1987 */  { fnXEQMENU,                   9,                           "XEQM09",                                      "XEQM09",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1988 */  { fnXEQMENU,                   10,                          "XEQM10",                                      "XEQM10",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1989 */  { fnXEQMENU,                   11,                          "XEQM11",                                      "XEQM11",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1990 */  { fnXEQMENU,                   12,                          "XEQM12",                                      "XEQM12",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1991 */  { fnXEQMENU,                   13,                          "XEQM13",                                      "XEQM13",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1992 */  { fnXEQMENU,                   14,                          "XEQM14",                                      "XEQM14",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
/* 1993 */  { fnXEQMENU,                   15,                          "XEQM15",                                      "XEQM15",                                      0,       0,       CAT_FNCT, SLS_ENABLED  },   //JM EXEC
