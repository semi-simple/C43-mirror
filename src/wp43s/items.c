...
/* 1829 */  { fnSetSetJM,                   JC_GGREEK,                   STD_alpha "gGRK",                              STD_alpha "gGRK",                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED},//JM ALPHA GREEK
...
/* 2064 */  { fnEqSolvGraph,                EQ_SOLVE,                    "xxSLV",                                       "xxSLV",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED},
/* 2065 */  { fnEqSolvGraph,                EQ_PLOT,                     "xxPLT",                                       "xxPLT",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED},

/* 2066 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED},
};
