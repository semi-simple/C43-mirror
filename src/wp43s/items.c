...
/* 1154 */  { addItemToBuffer,              ITM_ALOG_SYMBOL,             "",                                            "e" STD_SUB_E,                                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 1769 */  { fnRecall,                     RESERVED_VARIABLE_FV,        "",                                            "RCL FV",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 1770 */  { fnRecall,                     RESERVED_VARIABLE_IPONA,     "",                                            "i%/a",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 1771 */  { fnRecall,                     RESERVED_VARIABLE_NPER,      "",                                            "RCL n" STD_SUB_P,                             (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 1772 */  { fnRecall,                     RESERVED_VARIABLE_PERONA,    "",                                            "per/a",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
...
/* 1775 */  { fnSetSetJM,                   JC_FG_LINE,                  "fg" STD_SPACE_3_PER_EM "LINE",                "fg" STD_SPACE_3_PER_EM "LINE",                (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM UNDERLINING
/* 1776 */  { fnSetSetJM,                   JC_NO_BASE_SCREEN,           "No" STD_SPACE_6_PER_EM "MyM",                 "No" STD_SPACE_6_PER_EM "MyM",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM NOBASE MENU SETTING
/* 1777 */  { fnSetSetJM,                   JC_G_DOUBLETAP,              "G" STD_SPACE_3_PER_EM "2TAP",                 "G" STD_SPACE_3_PER_EM "2TAP",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM KEY TAP DOUBLE SETTING
/* 1778 */  { fnPlotStatJM,                 PLOT_LR,                     "ASS.ALL",                                     "ASS.ALL",                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1779 */  { fnP_All_Regs,                 0,                           STD_PRINTER "ALLr",                            STD_PRINTER "ALLr",                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 1780 */  { fnMultiplySI,                 85,                          "",                                            STD_DOT "f",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1781 */  { fnMultiplySI,                 88,                          "",                                            STD_DOT "p",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1782 */  { fnMultiplySI,                 91,                          "",                                            STD_DOT "n",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1783 */  { fnMultiplySI,                 94,                          "",                                            STD_DOT STD_mu,                                (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1784 */  { fnMultiplySI,                 97,                          "",                                            STD_DOT "m",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1785 */  { fnMultiplySI,                 103,                         "",                                            STD_DOT "k",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1786 */  { fnMultiplySI,                 106,                         "",                                            STD_DOT "M",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1787 */  { fnMultiplySI,                 109,                         "",                                            STD_DOT "G",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1788 */  { fnMultiplySI,                 112,                         "",                                            STD_DOT "T",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM PRE UNIT
/* 1789 */  { addItemToBuffer,              ITM_QOPPA,                   "",                                            STD_QOPPA,                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GREEK
/* 1790 */  { addItemToBuffer,              ITM_DIGAMMA,                 "",                                            STD_DIGAMMA,                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GREEK
/* 1791 */  { addItemToBuffer,              ITM_SAMPI,                   "",                                            STD_SAMPI,                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GREEK
/* 1792 */  { fnJM,                         7,                           "Y" STD_SPACE_3_PER_EM STD_RIGHT_ARROW STD_SPACE_3_PER_EM STD_DELTA, "Y" STD_SPACE_3_PER_EM STD_RIGHT_ARROW STD_SPACE_3_PER_EM STD_DELTA, (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_UNCHANGED},//JM EE
/* 1793 */  { fnJM,                         6,                           STD_DELTA STD_SPACE_3_PER_EM STD_RIGHT_ARROW STD_SPACE_3_PER_EM "Y", STD_DELTA STD_SPACE_3_PER_EM STD_RIGHT_ARROW STD_SPACE_3_PER_EM "Y", (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1794 */  { fnJM,                         9,                           "AtoSYM",                                      STD_RIGHT_ARROW STD_SPACE_3_PER_EM "012",      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1795 */  { fnJM,                         8,                           "SYMtoA",                                      STD_RIGHT_ARROW STD_SPACE_3_PER_EM "abc",      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1796 */  { fnJM,                         10,                          "e^" STD_THETA "j",                            "e^" STD_THETA "j",                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1797 */  { fnJM,                         11,                          "STO" STD_SPACE_3_PER_EM "3Z",                 "STO" STD_SPACE_3_PER_EM "3Z",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1798 */  { fnJM,                         12,                          "RCL" STD_SPACE_3_PER_EM "3Z",                 "RCL" STD_SPACE_3_PER_EM "3Z",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1799 */  { fnJM,                         13,                          "STO" STD_SPACE_3_PER_EM "3V",                 "STO" STD_SPACE_3_PER_EM "3V",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1800 */  { fnJM,                         14,                          "RCL" STD_SPACE_3_PER_EM "3V",                 "RCL" STD_SPACE_3_PER_EM "3V",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1801 */  { fnJM,                         15,                          "STO" STD_SPACE_3_PER_EM "3I",                 "STO" STD_SPACE_3_PER_EM "3I",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1802 */  { fnJM,                         16,                          "RCL" STD_SPACE_3_PER_EM "3I",                 "RCL" STD_SPACE_3_PER_EM "3I",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1803 */  { fnJM,                         17,                          "3V" STD_DIVIDE "3I",                          "V" STD_DIVIDE "I",                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1804 */  { fnJM,                         18,                          "3I" STD_CROSS "3Z",                           "I" STD_CROSS "Z",                             (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1805 */  { fnJM,                         19,                          "3V" STD_DIVIDE "3Z",                          "V" STD_DIVIDE "Z",                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1806 */  { fnJM,                         20,                          "X" STD_SPACE_3_PER_EM STD_RIGHT_ARROW STD_SPACE_3_PER_EM "BAL", "X" STD_SPACE_3_PER_EM STD_RIGHT_ARROW STD_SPACE_3_PER_EM "BAL", (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM EE
/* 1807 */  { fnJM,                         45,                          "",                                            "A",                                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1808 */  { fn_cnst_op_a,                 NOPARAM,                     "op_a",                                        "a",                                           (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM Operator a
/* 1809 */  { fn_cnst_op_aa,                NOPARAM,                     "op_a" STD_SUP_2,                              "a" STD_SUP_2,                                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM Operator a.a
/* 1810 */  { fn_cnst_op_j,                 NOPARAM,                     "op_j",                                        "j",                                           (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM Operator j
/* 1811 */  { fnChangeBaseJM,               2,                           "BIN",                                         "BIN",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM HEX
/* 1812 */  { fnChangeBaseJM,               8,                           "OCT",                                         "OCT",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM HEX
/* 1813 */  { fnChangeBaseJM,               10,                          "DEC",                                         "DEC",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM HEX
/* 1814 */  { fnChangeBaseJM,               16,                          "HEX",                                         "HEX",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM HEX
/* 1815 */  { fnSetWordSize,                8,                           "8-BIT",                                       "8-BIT",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM HEX
/* 1816 */  { fnSetWordSize,                16,                          "16-BIT",                                      "16-BIT",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM HEX
/* 1817 */  { fnSetWordSize,                32,                          "32-BIT",                                      "32-BIT",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM HEX
/* 1818 */  { fnSetWordSize,                64,                          "64-BIT",                                      "64-BIT",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM HEX
/* 1819 */  { fnHrDeg,                      NOPARAM,                     "HOUR",                                        "HOUR",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1820 */  { fnMinute,                     NOPARAM,                     "MIN",                                         "MIN",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1821 */  { fnSecond,                     NOPARAM,                     "SEC",                                         "SEC",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1822 */  { fnToTime,                     NOPARAM,                     STD_RIGHT_ARROW "TIME",                        STD_RIGHT_ARROW "TIME",                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1823 */  { fnTimeTo,                     NOPARAM,                     "TIME" STD_RIGHT_ARROW,                        "TIME" STD_RIGHT_ARROW,                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1824 */  { fnSetSetJM,                   JC_GGREEK,                   STD_alpha "gGRK",                              STD_alpha "gGRK",                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM ALPHA GREEK
/* 1825 */  { addItemToBuffer,              ITM_qoppa,                   "",                                            STD_qoppa,                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GREEK
/* 1826 */  { addItemToBuffer,              ITM_digamma,                 "",                                            STD_digamma,                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GREEK
/* 1827 */  { addItemToBuffer,              ITM_sampi,                   "",                                            STD_sampi,                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM GREEK
/* 1828 */  { fnKeyCC,                      KEY_COMPLEX,                 "COMPLEX",                                     "COMPLEX",                                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM Change CC to COMPLEX
/* 1829 */  { fnToPolar2,                   NOPARAM,                     STD_RIGHT_ARROW "POLAR",                       STD_RIGHT_ARROW "P",                           (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM TEXT & point to function to add POLAR/RECT
/* 1830 */  { fnToRect2,                    NOPARAM,                     STD_RIGHT_ARROW "RECT",                        STD_RIGHT_ARROW "R",                           (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//SWAPPED ARROW DIRECTION & JM TEXT & point to function to add POLAR/RECT
/* 1831 */  { fneRPN,                       1,                           "",                                            "eRPN",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1832 */  { fneRPN,                       0,                           "",                                            "RPN",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1833 */  { fnSetSetJM,                   JC_ERPN,                     "eRPN",                                        "eRPN",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM eRPN
/* 1834 */  { fnSetSetJM,                   JC_HOME_TRIPLE,              "HOME.3",                                      "HOME.3",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM HOME.3
/* 1835 */  { fnSetSetJM,                   JC_SHFT_4s,                  "",                                            "SH_4s",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM SHIFT CANCEL
/* 1836 */  { fnSetSetJM,                   JC_BCR,                      "",                                            "CPXRES",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//dr
/* 1837 */  { fnSetSetJM,                   JC_BLZ,                      "",                                            "LEAD0",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//dr
/* 1838 */  { fnSetSetJM,                   JC_UC,                       "",                                            STD_case,                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM CASE
/* 1839 */  { fnSetSetJM,                   JC_BASE_HOME,                "_HOME",                                       "HOME",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM eRPN
/* 1840 */  { fnSetSetJM,                   JC_BASE_AHOME,               "_" STD_alpha "HOME",                          STD_alpha "HOME",                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM eRPN
/* 1841 */  { fnSetSetJM,                   JC_H_SUM,                    "",                                            "SUMRY",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JMHOME
/* 1842 */  { fnSetSetJM,                   JC_H_MIR,                    "",                                            "REPLCA",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JMHOME
/* 1843 */  { fnSetSetJM,                   JC_H_FIX,                    "",                                            "FIXED",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JMHOME
/* 1844 */  { fnSetSetJM,                   JC_SH_3T,                    "",                                            "SH.3T",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_ENABLED  },
/* 1845 */  { fnSetSetJM,                   JC_LARGELI,                  "LARGELI",                                     "LRG_LI",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 1846 */  { fnDisplayFormatSigFig,        TM_VALUE,                    "SIG",                                         "SIG",                                         (0 << TAM_MAX_BITS) |    15, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM SIGFIG
/* 1847 */  { fnDisplayFormatUnit,          TM_VALUE,                    "UNIT",                                        "UNIT",                                        (0 << TAM_MAX_BITS) |    15, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM UNIT
/* 1848 */  { fnRound2,                     NOPARAM,                     "ROUND",                                       "ROUND",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1849 */  { fnRoundi2,                    NOPARAM,                     "ROUNDI",                                      "ROUNDI",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1850 */  { fnDumpMenus,                  NOPARAM,                     "",                                            "DUMPMNU",                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},
/* 1851 */  { fnJM_2SI,                     NOPARAM,                     STD_RIGHT_ARROW "I",                           STD_RIGHT_ARROW "I",                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },//JM Copy of 1925
/* 1852 */  { fnChangeBaseMNU,              NOPARAM,                     "MODE#",                                       "MODE#",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 1853 */  { fnDRG,                        NOPARAM,                     "DRG",                                         "DRG",                                         (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 1854 */  { fnCla,                        NOPARAM,                     "CLA",                                         "CLA",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_DISABLED  | US_UNCHANGED},//GRAPH
/* 1855 */  { fnCln,                        NOPARAM,                     "CLN",                                         "CLN",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_DISABLED  | US_UNCHANGED},//GRAPH
/* 1856 */  { fnSetSetJM,                   DM_ANY,                      "",                                            "DENANY",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM DEN
/* 1857 */  { fnSetSetJM,                   DM_FIX,                      "",                                            "DENFIX",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM DEN
/* 1858 */  { itemToBeCoded,                NOPARAM,                     "",                                            "CASE UP",                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM CASE
/* 1859 */  { itemToBeCoded,                NOPARAM,                     "",                                            "CASE DN",                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM CASE
/* 1860 */  { fnListXY,                     NOPARAM,                     "LISTXY",                                      "LISTXY",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 1861 */  { fnShowJM,                     JC_ERPN,                     "eRPN?",                                       "eRPN?",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },//JM SHOW
/* 1862 */  { fnSysFreeMem,                 NOPARAM,                     "",                                            "HEAP",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},
/* 1863 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Inl. Tst",                                    (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED},//INLINE_TEST
/* 1864 */  { fnSetInlineTest,              JC_ITM_TST,                  "",                                            "Test",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//INLINE_TEST
/* 1865 */  { fnGetInlineTestBsToX,         NOPARAM,                     "",                                            "Get BS",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//INLINE_TEST
/* 1866 */  { fnSetInlineTestXToBs,         NOPARAM,                     "",                                            "Set BS",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED},//INLINE_TEST
/* 1867 */  { fnInDefault,                  ID_DP,                       "i" STD_SPACE_3_PER_EM "REAL",                 "i" STD_SPACE_3_PER_EM "REAL",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM INPUT DEFAULT
/* 1868 */  { fnShowJM,                     JM_INP_DFLT,                 "",                                            "in" STD_SPACE_3_PER_EM "Dflt?",               (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM INPUT DEFAULT
/* 1869 */  { fnInDefault,                  ID_CPXDP,                    "i" STD_SPACE_3_PER_EM "CPX",                  "i" STD_SPACE_3_PER_EM "CPX",                  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM INPUT DEFAULT
/* 1870 */  { fnInDefault,                  ID_SI,                       "i" STD_SPACE_3_PER_EM "SI",                   "i" STD_SPACE_3_PER_EM "SI",                   (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM INPUT DEFAULT
/* 1871 */  { fnInDefault,                  ID_LI,                       "i" STD_SPACE_3_PER_EM "LI",                   "i" STD_SPACE_3_PER_EM "LI",                   (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM INPUT DEFAULT
/* 1872 */  { fnUserJM,                     USER_V43,                    "",                                            "V43 RT",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//J=V43
/* 1873 */  { fnJM,                         48,                          "",                                            "f/g",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM Shift replacement
/* 1874 */  { fnUserJM,                     USER_DEFAULTS,               "",                                            "U" STD_SIGMA " CC",                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1875 */  { fnUserJM,                     USER_COMPLEX,                "",                                            "U" STD_UP_ARROW " CC",                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1876 */  { fnUserJM,                     USER_SHIFTS,                 "",                                            "C43 ALT",                                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM USER
/* 1877 */  { fnUserJM,                     USER_RESET,                  "",                                            "RESET",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1878 */  { fnSigmaAssign,                ITM_AIM,                     "",                                            STD_SIGMA STD_alpha,                           (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1879 */  { fnSigmaAssign,                ITM_CC,                      "",                                            STD_SIGMA "CC",                                (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1880 */  { fnSigmaAssign,                ITM_SHIFTg,                  "",                                            STD_SIGMA "g",                                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1881 */  { fnSigmaAssign,                -MNU_MyMenu,                 "",                                            STD_SIGMA "MyM",                               (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1882 */  { fnSigmaAssign,                ITM_DRG,                     "",                                            STD_SIGMA "DRG",                               (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1883 */  { fnSigmaAssign,                ITM_PR,                      "",                                            STD_SIGMA "PRGM",                              (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1884 */  { fnSigmaAssign,                ITM_USERMODE,                "",                                            STD_SIGMA "USER",                              (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1885 */  { fnSigmaAssign,                -MNU_HOME,                   "",                                            STD_SIGMA "HOME",                              (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1886 */  { fnSigmaAssign,                ITM_SIGMAPLUS,               "",                                            STD_SIGMA "+",                                 (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1887 */  { fnSigmaAssign,                ITM_SNAP,                    "",                                            STD_SIGMA "SNAP",                              (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1888 */  { fnGetSigmaAssignToX,          NOPARAM,                     "",                                            STD_SIGMA "+ toX",                             (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1889 */  { fnUserJM,                     JM_ASSIGN,                   "",                                            "ASSIGN",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1890 */  { fnUserJM,                     JM_SEEK_FN,                  "FN" STD_DOT "ASN",                            "FN" STD_DOT "ASN",                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},
/* 1891 */  { fnInDefault,                  ID_43S,                      "i" STD_SPACE_3_PER_EM "LI/RL",                "i" STD_SPACE_3_PER_EM "LI/RL",                (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED},//JM INPUT DEFAULT
/* 1892 */  { fnXEQMXXEQ,                   NOPARAM,                     "X.XEQ",                                       "X.XEQ",                                       (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 1893 */  { fnUserJM,                     USER_V43LT,                  "",                                            "V43 LT",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//J=V43
/* 1894 */  { fnUserJM,                     USER_COPY,                   "",                                            "COPY" STD_RIGHT_ARROW "U",                    (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 1911 */  { fnJM,                         46,                          "",                                            "zyx" STD_RIGHT_ARROW "M",                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
...
/* 1945 */  { fnJMUSERmode,                 256+0,                       "",                                            "p00U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1946 */  { fnJMUSERmode_f,               256+0,                       "",                                            "f00U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1947 */  { fnJMUSERmode_g,               256+0,                       "",                                            "g00U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1948 */  { fnJMUSERmode,                 256+1,                       "",                                            "p01U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1949 */  { fnJMUSERmode_f,               256+1,                       "",                                            "f01U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1950 */  { fnJMUSERmode_g,               256+1,                       "",                                            "g01U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1951 */  { fnJMUSERmode,                 256+2,                       "",                                            "p02U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1952 */  { fnJMUSERmode_f,               256+2,                       "",                                            "f02U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1953 */  { fnJMUSERmode_g,               256+2,                       "",                                            "g02U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1954 */  { fnJMUSERmode,                 256+3,                       "",                                            "p03U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1955 */  { fnJMUSERmode_f,               256+3,                       "",                                            "f03U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1956 */  { fnJMUSERmode_g,               256+3,                       "",                                            "g03U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1957 */  { fnJMUSERmode,                 256+4,                       "",                                            "p04U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1958 */  { fnJMUSERmode_f,               256+4,                       "",                                            "f04U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1959 */  { fnJMUSERmode_g,               256+4,                       "",                                            "g04U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1960 */  { fnJMUSERmode,                 256+5,                       "",                                            "p05U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1961 */  { fnJMUSERmode_f,               256+5,                       "",                                            "f05U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
/* 1962 */  { fnJMUSERmode_g,               256+5,                       "",                                            "g05U",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},//JM User mode (Will remove later - reserved)
...
/* 2039 */  { fnJM,                         47,                          "",                                            "M" STD_RIGHT_ARROW "zyx",                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2040 */  { fnPlotReset,                  NOPARAM,                     "PLTRST",                                      "PLTRST",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2041 */  { fnStatDemo0,                  NOPARAM,                     "",                                             "DEMO0"                ,                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 2042 */  { fnStatDemo1,                  NOPARAM,                     "",                                             "DEMO1"                ,                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 2043 */  { fnStatDemo2,                  NOPARAM,                     "",                                             "DEMO2"                ,                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED  },
/* 2044 */  { fnStatDemo105,                NOPARAM,                     "",                                            "DEM105",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2045 */  { fnStatDemo107,                NOPARAM,                     "",                                            "DEM107",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2046 */  { fnStatDemo109,                NOPARAM,                     "",                                            "DEM109",                                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED},
/* 2047 */  { fnCurveFitting_T,             CF_EXPONENTIAL_FITTING_EX,   "ExpF",                                        "ExpF",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2048 */  { fnCurveFitting_T,             CF_LINEAR_FITTING_EX,        "LinF",                                        "LinF",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2049 */  { fnCurveFitting_T,             CF_LOGARITHMIC_FITTING_EX,   "LogF",                                        "LogF",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2050 */  { fnCurveFitting_T,             CF_ORTHOGONAL_FITTING_EX,    "OrthoF",                                      "OrthoF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2051 */  { fnCurveFitting_T,             CF_POWER_FITTING_EX,         "PowerF",                                      "PowerF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2052 */  { fnCurveFitting_T,             CF_GAUSS_FITTING_EX,         "GaussF",                                      "GaussF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2053 */  { fnCurveFitting_T,             CF_CAUCHY_FITTING_EX,        "CauchF",                                      "CauchF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2054 */  { fnCurveFitting_T,             CF_PARABOLIC_FITTING_EX,     "ParabF",                                      "ParabF",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2055 */  { fnCurveFitting_T,             CF_HYPERBOLIC_FITTING_EX,    "HypF",                                        "HypF",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
/* 2056 */  { fnCurveFitting_T,             CF_ROOT_FITTING_EX,          "RootF",                                       "RootF",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED  },
