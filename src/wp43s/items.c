...
void runFunction(int16_t func) {
  ...
  if(calcMode != CM_TAM && TM_VALUE <= tamMode && tamMode <= TM_CMP) {
    ...
    if(func == ITM_FIX || func == ITM_SCI || func == ITM_ENG || func == ITM_ALL || func == ITM_GAP) {
      tamNumberMax = 15;
    }
...
/*   24 */  { fnArccos,                    NOPARAM,                     "arccos",                                      "arccos",                                      CAT_FNCT, SLS_ENABLED  },
/*   25 */  { fnArccosh,                   NOPARAM,                     "arcosh",                                      "arcosh",                                      CAT_FNCT, SLS_ENABLED  },
/*   26 */  { fnArcsin,                    NOPARAM,                     "arcsin",                                      "arcsin",                                      CAT_FNCT, SLS_ENABLED  },
/*   27 */  { fnArctan,                    NOPARAM,                     "arctan",                                      "arctan",                                      CAT_FNCT, SLS_ENABLED  },
...
/*   86 */  { itemToBeCoded,               NOPARAM,                     "CONST",                                       "CONST",                                       CAT_MENU, SLS_UNCHANGED},
...
/*   92 */  { fnCos,                       NOPARAM,                     "cos",                                         "cos",                                         CAT_FNCT, SLS_ENABLED  },
...
/*  310 */  { fnLn,                        NOPARAM,                     "LN",                                          "ln",                                          CAT_FNCT, SLS_ENABLED  },
...
/*  323 */  { fnLog10,                     NOPARAM,                     "LOG" STD_SUB_10,                              "lg",                                          CAT_FNCT, SLS_ENABLED  },
...
/*  487 */  { registerBrowser,             NOPARAM,                     "RBR",                                         "RBR",                                         CAT_FNCT, SLS_UNCHANGED},
...
/*  587 */  { flagBrowser,                 NOPARAM,                     "STATUS",                                      "STATUS",                                      CAT_FNCT, SLS_UNCHANGED},
...
/*  618 */  { fnTan,                       NOPARAM,                     "tan",                                         "tan",                                         CAT_FNCT, SLS_ENABLED  },
...
/*  637 */  { itemToBeCoded,               NOPARAM,                     "TRI",                                         "TRI",                                         CAT_MENU, SLS_UNCHANGED},
...
/*  646 */  { itemToBeCoded,               NOPARAM,                     "U" STD_RIGHT_ARROW,                           "U" STD_RIGHT_ARROW,                           CAT_MENU, SLS_UNCHANGED},
...
/*  714 */  { itemToBeCoded,               NOPARAM,                     STD_alpha ".FN",                               STD_alpha ".FN",                               CAT_MENU, SLS_UNCHANGED},
...
/*  779 */  { fnChangeSign,                ITM_CHS,                     "+/-",                                         "+/-",                                         CAT_FNCT, SLS_ENABLED  },
...
/*  798 */  { fnToRect,                    NOPARAM,                     STD_RIGHT_ARROW "REC",                         "R" STD_LEFT_ARROW,                            CAT_FNCT, SLS_ENABLED  },
...
/*  821 */  { itemToBeCoded,               NOPARAM,                     STD_MEASURED_ANGLE STD_RIGHT_ARROW,            STD_MEASURED_ANGLE STD_RIGHT_ARROW,            CAT_MENU, SLS_UNCHANGED},
...
/* 1487 */  { addItemToBuffer,             ITM_EXPONENT,                "",                                            "E",                                           CAT_NONE, SLS_UNCHANGED},
...
/* 1506 */  { itemToBeCoded,               NOPARAM,                     "UNDO",                                        STD_UNDO,                                      CAT_NONE, SLS_UNCHANGED},
/* 1507 */  { itemToBeCoded,               NOPARAM,                     "P/R",                                         "P/R",                                         CAT_NONE, SLS_UNCHANGED},
