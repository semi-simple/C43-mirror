...
void log2LonI(void) {
  ...
  if(real16IsZero(REGISTER_REAL34_DATA(REGISTER_X))) {
  ...
  else if(real16IsPositive(REGISTER_REAL34_DATA(REGISTER_X))) { // Positive
    ...
    real16Divide(REGISTER_IMAG16_DATA(REGISTER_X), const16_ln2, REGISTER_IMAG16_DATA(REGISTER_X));
  }
...
void log2Re16(void) {
  if(real16IsNaN(REGISTER_REAL16_DATA(REGISTER_X))) {
    displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
    #if (EXTRA_INFO_ON_CALC_ERROR == 1)
      showInfoDialog("In function log2Re16:", "cannot use NaN as X input of log" STD_SUB_2, NULL, NULL);
    #endif
    return;
  }
...
void log2Co16(void) {
  if(real16IsNaN(REGISTER_REAL16_DATA(REGISTER_X)) || real16IsNaN(REGISTER_IMAG16_DATA(REGISTER_X))) {
    displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
    #if (EXTRA_INFO_ON_CALC_ERROR == 1)
      showInfoDialog("In function log2Co16:", "cannot use NaN as X input of log" STD_SUB_2, NULL, NULL);
    #endif
    return;
  }
  ...
  if(real16IsZero(REGISTER_REAL16_DATA(REGISTER_X)) && real16IsZero(REGISTER_IMAG16_DATA(REGISTER_X))) {
    if(getFlag(FLAG_DANGER)) {
      ...
      displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
      #if (EXTRA_INFO_ON_CALC_ERROR == 1)
        showInfoDialog("In function log2Co16:", "cannot calculate log" STD_SUB_2, NULL, NULL);
      #endif
    }
  }
  else {
    ...
    real34ToReal16(&theta34, REGISTER_IMAG16_DATA(REGISTER_X));
  }
}
...
void log2An16(void) {
  if(real16IsNaN(REGISTER_REAL16_DATA(REGISTER_X))) {
    displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
    #if (EXTRA_INFO_ON_CALC_ERROR == 1)
      showInfoDialog("In function log2An16:", "cannot use NaN as X input of log" STD_SUB_2, NULL, NULL);
    #endif
    return;
  }
  ...
  if(real16IsZero(REGISTER_REAL16_DATA(REGISTER_X))) {
    if(getFlag(FLAG_DANGER)) {
      ...
      displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
      #if (EXTRA_INFO_ON_CALC_ERROR == 1)
        showInfoDialog("In function log2An16:", "cannot calculate log2(0)", NULL, NULL);
      #endif
    }
  }
  else if(real16IsPositive(REGISTER_REAL16_DATA(REGISTER_X))) { // Positive
    ...
    displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
    #if (EXTRA_INFO_ON_CALC_ERROR == 1)
      showInfoDialog("In function log2An16:", "cannot calculate log2 of a negative number when CPXRES is not set!", NULL, NULL);
    #endif
  }
}
...
void log2Re34(void) {
  if(real34IsNaN(REGISTER_REAL34_DATA(REGISTER_X))) {
    displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
    #if (EXTRA_INFO_ON_CALC_ERROR == 1)
      showInfoDialog("In function log2Re34:", "cannot use NaN as X input of log" STD_SUB_2, NULL, NULL);
    #endif
    return;
  }
  ...
  if(real34IsZero(REGISTER_REAL34_DATA(REGISTER_X))) {
    ...
    real34Divide(REGISTER_IMAG34_DATA(REGISTER_X), const34_ln2, REGISTER_IMAG34_DATA(REGISTER_X));
  }
  else if(getFlag(FLAG_DANGER)) {
...
void log2Co34(void) {
  if(real34IsNaN(REGISTER_REAL34_DATA(REGISTER_X)) || real34IsNaN(REGISTER_IMAG34_DATA(REGISTER_X))) {
    displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
    #if (EXTRA_INFO_ON_CALC_ERROR == 1)
      showInfoDialog("In function log2Co34:", "cannot use NaN as X input of log" STD_SUB_2, NULL, NULL);
    #endif
    return;
  }
  ...
  if(real34IsZero(REGISTER_REAL34_DATA(REGISTER_X)) && real34IsZero(REGISTER_IMAG34_DATA(REGISTER_X))) {
    if(getFlag(FLAG_DANGER)) {
      ...
      displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
      #if (EXTRA_INFO_ON_CALC_ERROR == 1)
        showInfoDialog("In function log2Co34:", "cannot calculate log" STD_SUB_2, NULL, NULL);
      #endif
    }
  }
  else {
    ...
    real51Divide(&real51, const51_ln2, &real51);
    real51ToReal34(&real51, REGISTER_REAL34_DATA(REGISTER_X));
    real34Divide(&theta34, const34_ln2, REGISTER_IMAG34_DATA(REGISTER_X));
  }
}
...
void log2An34(void) {
  if(real34IsNaN(REGISTER_REAL34_DATA(REGISTER_X))) {
    displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
    #if (EXTRA_INFO_ON_CALC_ERROR == 1)
      showInfoDialog("In function log2An34:", "cannot use NaN as X input of log" STD_SUB_2, NULL, NULL);
    #endif
    return;
  }
  ...
  if(real34IsZero(REGISTER_REAL34_DATA(REGISTER_X))) {
    if(getFlag(FLAG_DANGER)) {
      ...
      displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
      #if (EXTRA_INFO_ON_CALC_ERROR == 1)
        showInfoDialog("In function log2An34:", "cannot calculate log2(0)", NULL, NULL);
      #endif
    }
  }
  else if(real34IsPositive(REGISTER_REAL34_DATA(REGISTER_X))) { // Positive
    ...
    displayCalcErrorMessage(ERROR_ARG_EXCEEDS_FUNCTION_DOMAIN, ERR_REGISTER_LINE, REGISTER_X);
    #if (EXTRA_INFO_ON_CALC_ERROR == 1)
      showInfoDialog("In function log2An34:", "cannot calculate log2 of a negative number when CPXRES is not set!", NULL, NULL);
    #endif
  }
}
