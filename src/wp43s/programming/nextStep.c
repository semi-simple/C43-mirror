  ...
  switch(paramMode) {
    ...
    case PARAM_LABEL:
         if(opParam <= 109) { // Local labels from 00 to 99 and from A to J
           ...
           printf("In function countOpBytes: case PARAM_LABEL, %u is not a valid parameter!", opParam);
           return NULL;
         }
    ...
    case PARAM_REGISTER:
         if(opParam <= LAST_LOCAL_REGISTER) { // Global registers from 00 to 99, lettered registers from X to K, and local registers from .00 to .98
           ...
           printf("In function countOpBytes: case PARAM_REGISTER, %u is not a valid parameter!", opParam);
           return NULL;
         }
    ...
    case PARAM_FLAG:
         if(opParam <= LAST_LOCAL_FLAG) { // Global flags from 00 to 99, lettered flags from X to K, and local flags from .00 to .15 (or .31)
           ...
           printf("In function countOpBytes: case PARAM_FLAG, %u is not a valid parameter!", opParam);
           return NULL;
         }
    ...
    case PARAM_NUMBER:
         if(opParam <= 99) { // Value from 0 to 99
           ...
           printf("In function countOpBytes: case PARAM_NUMBER, %u is not a valid parameter!", opParam);
           return NULL;
         }
    ...
    case PARAM_COMPARE:
         if(opParam <= LAST_LOCAL_REGISTER || opParam == VALUE_0 || opParam == VALUE_1) { // Global registers from 00 to 99, lettered registers from X to K, and local registers from .00 to .98 OR value 0 OR value 1
           ...
           printf("In function countOpBytes: case PARAM_COMPARE, %u is not a valid parameter!", opParam);
           return NULL;
         }
