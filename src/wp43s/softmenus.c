...
const int16_t menu_CLR[]         = { ITM_CLSIGMA,                   ITM_CLP,                    ITM_CF,                   ITM_CLMENU,            ITM_CLCVAR,                  ITM_CLX,
                                     ...
                                     ITM_CLALL,                     ITM_NULL,                   ITM_NULL,                 ITM_CLAIM,             ITM_CLA,                     ITM_RESET                     };
...
#ifndef DMCP_BUILD
                                     -MNU_TRI,                      ITM_NULL,                   ITM_NULL,                 ITM_NULL,              ITM_RECT,                    ITM_POLAR,                         //JM modifoed
#endif
#ifdef DMCP_BUILD
                                     ITM_SYSTEM,                    -MNU_TRI,                   ITM_NULL,                 ITM_NULL,              ITM_RECT,                    ITM_POLAR,                     
#endif
