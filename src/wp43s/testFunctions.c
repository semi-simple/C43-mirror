...
void testFunctions(void) {
    ...
    if(strcmp(indexOfItems[CST_24                       ].itemPrinted, "l" STD_SUB_P STD_SUB_L                                                      )) {printf("item %" FMT16S " is not CST_24                       \n", CST_24                       ); exit(0);}
    ...
    if(strcmp(indexOfItems[CST_29                       ].itemPrinted, "M" STD_SUB_P STD_SUB_L                                                      )) {printf("item %" FMT16S " is not CST_29                       \n", CST_29                       ); exit(0);}
    ...
    if(strcmp(indexOfItems[CST_54                       ].itemPrinted, "t" STD_SUB_P STD_SUB_L                                                      )) {printf("item %" FMT16S " is not CST_54                       \n", CST_54                       ); exit(0);}
    ...
    if(strcmp(indexOfItems[ITM_dddEL                    ].itemPrinted, STD_ELLIPSIS "EL"                                                            )) {printf("item %" FMT16S " is not ITM_dddEL                    \n", ITM_dddEL                    ); exit(0);}
    if(strcmp(indexOfItems[ITM_dddIJ                    ].itemPrinted, STD_ELLIPSIS "IJ"                                                            )) {printf("item %" FMT16S " is not ITM_dddIJ                    \n", ITM_dddIJ                    ); exit(0);}
    ...
    if(strcmp(indexOfItems[ITM_VANGLE                   ].itemPrinted, "VANGLE"                                                                     )) {printf("item %" FMT16S " is not ITM_VANGLE                   \n", ITM_VANGLE                   ); exit(0);}
