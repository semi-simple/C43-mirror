...
uint8_t                angularMode, groupingGap, dateFormat, curveFitting;
...
uint8_t                numScreensNumericFont, previousCalcMode;
bool_t                 hourGlassIconEnabled, watchIconEnabled, userModeEnabled; //, displayDateTime;
