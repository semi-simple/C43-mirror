...
//XEQM TYPE1 ORIGINAL FULL SELECTED LIST
                      ...
                      if (strcompare(str,"Z" )) { *com = ITM_STACK_Z;} else
                      if (strcompare(str,"T" )) { *com = ITM_STACK_T;} else
                      if (strcompare(str,"A" )) { *com = ITM_STACK_A;} else
                      if (strcompare(str,"B" )) { *com = ITM_STACK_B;} else
                      if (strcompare(str,"C" )) { *com = ITM_STACK_C;} else
                      if (strcompare(str,"D" )) { *com = ITM_STACK_D;} else
                      if (strcompare(str,"REG_L" )) { *com = ITM_REG_L;} else
                      if (strcompare(str,"REG_I" )) { *com = ITM_REG_I;} else
                      if (strcompare(str,"REG_J" )) { *com = ITM_REG_J;} else
                      if (strcompare(str,"REG_K" )) { *com = ITM_REG_K;} else
                      if (strcompare(str,"IND>" )) { *com = ITM_INDIRECTION;} else
                      if (strcompare(str,"REG_A" )) { *com = ITM_REG_A;} else
                      if (strcompare(str,"REG_B" )) { *com = ITM_REG_B;} else
                      if (strcompare(str,"REG_C" )) { *com = ITM_REG_C;} else
                      if (strcompare(str,"REG_D" )) { *com = ITM_REG_D;} else
                      ...
                      if (strcompare(str,"XOUT" )) { *com = ITM_XOUT;} else
